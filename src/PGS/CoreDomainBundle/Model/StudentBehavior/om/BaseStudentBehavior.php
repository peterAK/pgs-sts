...
abstract class BaseStudentBehavior extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\StudentBehavior\\StudentBehaviorPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        StudentBehaviorPeer
     */
     ...
     * @return StudentBehavior The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = StudentBehaviorPeer::ID;
        }
    ...
    public function setStudentId($v)
    {
        ...
        if ($this->student_id !== $v) {
            $this->student_id = $v;
            $this->modifiedColumns[] = StudentBehaviorPeer::STUDENT_ID;
        }
    ...
    public function setBehaviorId($v)
    {
        ...
        if ($this->behavior_id !== $v) {
            $this->behavior_id = $v;
            $this->modifiedColumns[] = StudentBehaviorPeer::BEHAVIOR_ID;
        }
    ...
    public function setSchoolClassId($v)
    {
        ...
        if ($this->school_class_id !== $v) {
            ...
            $this->modifiedColumns[] = StudentBehaviorPeer::SCHOOL_CLASS_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StudentBehaviorPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StudentBehaviorPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->school_class_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 6; // 6 = StudentBehaviorPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating StudentBehavior object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = StudentBehaviorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = StudentBehaviorQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(StudentBehaviorPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(StudentBehaviorPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(StudentBehaviorPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                StudentBehaviorPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StudentBehaviorPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(StudentBehaviorPeer::STUDENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`student_id`';
        }
        if ($this->isColumnModified(StudentBehaviorPeer::BEHAVIOR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`behavior_id`';
        }
        if ($this->isColumnModified(StudentBehaviorPeer::SCHOOL_CLASS_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `student_behavior` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = StudentBehaviorPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = StudentBehaviorPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StudentBehavior'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StudentBehavior'][$this->getPrimaryKey()] = true;
        $keys = StudentBehaviorPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StudentBehaviorPeer::ID)) $criteria->add(StudentBehaviorPeer::ID, $this->id);
        if ($this->isColumnModified(StudentBehaviorPeer::STUDENT_ID)) $criteria->add(StudentBehaviorPeer::STUDENT_ID, $this->student_id);
        if ($this->isColumnModified(StudentBehaviorPeer::BEHAVIOR_ID)) $criteria->add(StudentBehaviorPeer::BEHAVIOR_ID, $this->behavior_id);
        if ($this->isColumnModified(StudentBehaviorPeer::SCHOOL_CLASS_ID)) $criteria->add(StudentBehaviorPeer::SCHOOL_CLASS_ID, $this->school_class_id);
        if ($this->isColumnModified(StudentBehaviorPeer::CREATED_AT)) $criteria->add(StudentBehaviorPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(StudentBehaviorPeer::UPDATED_AT)) $criteria->add(StudentBehaviorPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(StudentBehaviorPeer::DATABASE_NAME);
        $criteria->add(StudentBehaviorPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of StudentBehavior (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return StudentBehavior Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return StudentBehaviorPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new StudentBehaviorPeer();
        }
    ...
    public function getStudent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aStudent === null && ($this->student_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aStudent->addStudentBehaviors($this);
             */
        }
    ...
    public function getBehavior(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBehavior === null && ($this->behavior_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBehavior->addStudentBehaviors($this);
             */
        }
    ...
    public function getSchoolClass(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSchoolClass === null && ($this->school_class_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSchoolClass->addStudentBehaviors($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(StudentBehaviorPeer::DEFAULT_STRING_FORMAT);
    }
