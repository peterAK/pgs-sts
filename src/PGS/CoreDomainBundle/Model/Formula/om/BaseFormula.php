...
abstract class BaseFormula extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\Formula\\FormulaPeer';
     ...
     * @return Formula The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = FormulaPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = FormulaPeer::NAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = FormulaPeer::DESCRIPTION;
        }
    ...
    public function setFinalExamPoint($v)
    {
        ...
        if ($this->final_exam_point !== $v) {
            ...
            $this->modifiedColumns[] = FormulaPeer::FINAL_EXAM_POINT;
        }
    ...
    public function setDailyExamPoint($v)
    {
        ...
        if ($this->daily_exam_point !== $v) {
            ...
            $this->modifiedColumns[] = FormulaPeer::DAILY_EXAM_POINT;
        }
    ...
    public function setMidExamPoint($v)
    {
        ...
        if ($this->mid_exam_point !== $v) {
            ...
            $this->modifiedColumns[] = FormulaPeer::MID_EXAM_POINT;
        }
    ...
    public function setActivityPoint($v)
    {
        ...
        if ($this->activity_point !== $v) {
            ...
            $this->modifiedColumns[] = FormulaPeer::ACTIVITY_POINT;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FormulaPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FormulaPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->final_exam_point = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->daily_exam_point = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->mid_exam_point = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->activity_point = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            ...
            return $startcol + 9; // 9 = FormulaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Formula object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FormulaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = FormulaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(FormulaPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(FormulaPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(FormulaPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                FormulaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FormulaPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(FormulaPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(FormulaPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(FormulaPeer::FINAL_EXAM_POINT)) {
            $modifiedColumns[':p' . $index++]  = '`final_exam_point`';
        }
        if ($this->isColumnModified(FormulaPeer::DAILY_EXAM_POINT)) {
            $modifiedColumns[':p' . $index++]  = '`daily_exam_point`';
        }
        if ($this->isColumnModified(FormulaPeer::MID_EXAM_POINT)) {
            $modifiedColumns[':p' . $index++]  = '`mid_exam_point`';
        }
        if ($this->isColumnModified(FormulaPeer::ACTIVITY_POINT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `formula` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FormulaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FormulaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Formula'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Formula'][$this->getPrimaryKey()] = true;
        $keys = FormulaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getDescription(),
            $keys[3] => $this->getFinalExamPoint(),
            $keys[4] => $this->getDailyExamPoint(),
            $keys[5] => $this->getMidExamPoint(),
            $keys[6] => $this->getActivityPoint(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setFinalExamPoint($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setDailyExamPoint($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setMidExamPoint($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setActivityPoint($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FormulaPeer::ID)) $criteria->add(FormulaPeer::ID, $this->id);
        if ($this->isColumnModified(FormulaPeer::NAME)) $criteria->add(FormulaPeer::NAME, $this->name);
        if ($this->isColumnModified(FormulaPeer::DESCRIPTION)) $criteria->add(FormulaPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(FormulaPeer::FINAL_EXAM_POINT)) $criteria->add(FormulaPeer::FINAL_EXAM_POINT, $this->final_exam_point);
        if ($this->isColumnModified(FormulaPeer::DAILY_EXAM_POINT)) $criteria->add(FormulaPeer::DAILY_EXAM_POINT, $this->daily_exam_point);
        if ($this->isColumnModified(FormulaPeer::MID_EXAM_POINT)) $criteria->add(FormulaPeer::MID_EXAM_POINT, $this->mid_exam_point);
        if ($this->isColumnModified(FormulaPeer::ACTIVITY_POINT)) $criteria->add(FormulaPeer::ACTIVITY_POINT, $this->activity_point);
        if ($this->isColumnModified(FormulaPeer::CREATED_AT)) $criteria->add(FormulaPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(FormulaPeer::UPDATED_AT)) $criteria->add(FormulaPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(FormulaPeer::DATABASE_NAME);
        $criteria->add(FormulaPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Formula (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Formula Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Formula is new, it will return
    ...
    public function setSchoolClassCourses(PropelCollection $schoolClassCourses, PropelPDO $con = null)
    {
        ...
        foreach ($schoolClassCoursesToDelete as $schoolClassCourseRemoved) {
            $schoolClassCourseRemoved->setFormula(null);
        }
    ...
    protected function doAddSchoolClassCourse($schoolClassCourse)
    {
        ...
        $schoolClassCourse->setFormula($this);
    }
    ...
    public function removeSchoolClassCourse($schoolClassCourse)
    {
        if ($this->getSchoolClassCourses()->contains($schoolClassCourse)) {
            ...
            $schoolClassCourse->setFormula(null);
        }
     ...
     * Otherwise if this Formula is new, it will return
     * an empty collection; or if this Formula has previously
     * been saved, it will retrieve related SchoolClassCourses from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Formula.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(FormulaPeer::DEFAULT_STRING_FORMAT);
    }
