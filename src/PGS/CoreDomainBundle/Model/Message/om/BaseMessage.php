...
abstract class BaseMessage extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\Message\\MessagePeer';
    ...
    public function setOriginalId($v)
    {
        ...
        if ($this->original_id !== $v) {
            $this->original_id = $v;
            $this->modifiedColumns[] = MessagePeer::ORIGINAL_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->original_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->read = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
            $this->from_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->to_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MessagePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(MessagePeer::ORIGINAL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`original_id`';
        }
        if ($this->isColumnModified(MessagePeer::READ)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setFromId($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setToId($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MessagePeer::ORIGINAL_ID)) $criteria->add(MessagePeer::ORIGINAL_ID, $this->original_id);
