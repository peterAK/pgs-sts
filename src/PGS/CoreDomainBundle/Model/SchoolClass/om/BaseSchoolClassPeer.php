...
use PGS\CoreDomainBundle\Model\SchoolClass\map\SchoolClassTableMap;
...
abstract class BaseSchoolClassPeer
{
    ...
    const TABLE_NAME = 'school_class';

    /** the related Propel class for this table */
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\SchoolClass\\SchoolClass';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PGS\\CoreDomainBundle\\Model\\SchoolClass\\map\\SchoolClassTableMap';
    ...
    const ID = 'school_class.id';

    /** the column name for the grade_level_id field */
    const GRADE_LEVEL_ID = 'school_class.grade_level_id';

    /** the column name for the created_at field */
    const CREATED_AT = 'school_class.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'school_class.updated_at';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'GradeLevelId', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'gradeLevelId', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (SchoolClassPeer::ID, SchoolClassPeer::GRADE_LEVEL_ID, SchoolClassPeer::CREATED_AT, SchoolClassPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'GRADE_LEVEL_ID', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'grade_level_id', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'GradeLevelId' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'gradeLevelId' => 1, 'createdAt' => 2, 'updatedAt' => 3, ),
        BasePeer::TYPE_COLNAME => array (SchoolClassPeer::ID => 0, SchoolClassPeer::GRADE_LEVEL_ID => 1, SchoolClassPeer::CREATED_AT => 2, SchoolClassPeer::UPDATED_AT => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'GRADE_LEVEL_ID' => 1, 'CREATED_AT' => 2, 'UPDATED_AT' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'grade_level_id' => 1, 'created_at' => 2, 'updated_at' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SchoolClassPeer::GRADE_LEVEL_ID);
    ...
    /**
     * Method to invalidate the instance pool of all tables related to school_class
    ...
    public static function clearRelatedInstancePool()
    {
        ...
        // Invalidate objects in SchoolClassI18nPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = SchoolClassPeer::getInstanceFromPool($key))) {
            ...
            $cls = SchoolClassPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    public static function doCountJoinGradeLevel(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(SchoolClassPeer::GRADE_LEVEL_ID, GradeLevelPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of SchoolClass objects pre-filled with their GradeLevel objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinGradeLevel(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (SchoolClass) to $obj2 (GradeLevel)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (SchoolClass) to the collection in $obj2 (GradeLevel)
                $obj2->addSchoolClass($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseSchoolClassPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\SchoolClass\map\SchoolClassTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(SchoolClassPeer::OM_CLASS, $row, $colnum);
    ...
    /**
     * Deletes all rows from the school_class table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\SchoolClass\om\BaseSchoolClassPeer'));
