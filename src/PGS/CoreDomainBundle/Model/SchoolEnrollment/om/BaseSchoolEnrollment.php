...
abstract class BaseSchoolEnrollment extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\SchoolEnrollment\\SchoolEnrollmentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SchoolEnrollmentPeer
     */
     ...
     * @return SchoolEnrollment The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SchoolEnrollmentPeer::ID;
        }
    ...
    public function setStudentId($v)
    {
        ...
        if ($this->student_id !== $v) {
            $this->student_id = $v;
            $this->modifiedColumns[] = SchoolEnrollmentPeer::STUDENT_ID;
        }
    ...
    public function setSchoolId($v)
    {
        ...
        if ($this->school_id !== $v) {
            $this->school_id = $v;
            $this->modifiedColumns[] = SchoolEnrollmentPeer::SCHOOL_ID;
        }
    ...
    public function setSchoolYearId($v)
    {
        ...
        if ($this->school_year_id !== $v) {
            ...
            $this->modifiedColumns[] = SchoolEnrollmentPeer::SCHOOL_YEAR_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SchoolEnrollmentPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SchoolEnrollmentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = SchoolEnrollmentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SchoolEnrollment object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SchoolEnrollmentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = SchoolEnrollmentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SchoolEnrollmentPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(SchoolEnrollmentPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SchoolEnrollmentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                SchoolEnrollmentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SchoolEnrollmentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(SchoolEnrollmentPeer::STUDENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`student_id`';
        }
        if ($this->isColumnModified(SchoolEnrollmentPeer::SCHOOL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`school_id`';
        }
        if ($this->isColumnModified(SchoolEnrollmentPeer::SCHOOL_YEAR_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `school_enrollment` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SchoolEnrollmentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SchoolEnrollmentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SchoolEnrollment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SchoolEnrollment'][$this->getPrimaryKey()] = true;
        $keys = SchoolEnrollmentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SchoolEnrollmentPeer::ID)) $criteria->add(SchoolEnrollmentPeer::ID, $this->id);
        if ($this->isColumnModified(SchoolEnrollmentPeer::STUDENT_ID)) $criteria->add(SchoolEnrollmentPeer::STUDENT_ID, $this->student_id);
        if ($this->isColumnModified(SchoolEnrollmentPeer::SCHOOL_ID)) $criteria->add(SchoolEnrollmentPeer::SCHOOL_ID, $this->school_id);
        if ($this->isColumnModified(SchoolEnrollmentPeer::SCHOOL_YEAR_ID)) $criteria->add(SchoolEnrollmentPeer::SCHOOL_YEAR_ID, $this->school_year_id);
        if ($this->isColumnModified(SchoolEnrollmentPeer::CREATED_AT)) $criteria->add(SchoolEnrollmentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(SchoolEnrollmentPeer::UPDATED_AT)) $criteria->add(SchoolEnrollmentPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(SchoolEnrollmentPeer::DATABASE_NAME);
        $criteria->add(SchoolEnrollmentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of SchoolEnrollment (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SchoolEnrollment Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SchoolEnrollmentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SchoolEnrollmentPeer();
        }
    ...
    public function getStudent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aStudent === null && ($this->student_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aStudent->addSchoolEnrollments($this);
             */
        }
    ...
    public function getSchool(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSchool === null && ($this->school_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSchool->addSchoolEnrollments($this);
             */
        }
    ...
    public function getSchoolYear(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSchoolYear === null && ($this->school_year_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSchoolYear->addSchoolEnrollments($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SchoolEnrollmentPeer::DEFAULT_STRING_FORMAT);
    }
