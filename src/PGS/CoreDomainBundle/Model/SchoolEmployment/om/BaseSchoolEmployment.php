...
abstract class BaseSchoolEmployment extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\SchoolEmployment\\SchoolEmploymentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SchoolEmploymentPeer
     */
     ...
     * @return SchoolEmployment The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SchoolEmploymentPeer::ID;
        }
    ...
    public function setEmployeeId($v)
    {
        ...
        if ($this->employee_id !== $v) {
            $this->employee_id = $v;
            $this->modifiedColumns[] = SchoolEmploymentPeer::EMPLOYEE_ID;
        }
    ...
    public function setSchoolId($v)
    {
        ...
        if ($this->school_id !== $v) {
            $this->school_id = $v;
            $this->modifiedColumns[] = SchoolEmploymentPeer::SCHOOL_ID;
        }
    ...
    public function setSchoolYearId($v)
    {
        ...
        if ($this->school_year_id !== $v) {
            ...
            $this->modifiedColumns[] = SchoolEmploymentPeer::SCHOOL_YEAR_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SchoolEmploymentPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SchoolEmploymentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = SchoolEmploymentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SchoolEmployment object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SchoolEmploymentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = SchoolEmploymentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SchoolEmploymentPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(SchoolEmploymentPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SchoolEmploymentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                SchoolEmploymentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SchoolEmploymentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(SchoolEmploymentPeer::EMPLOYEE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`employee_id`';
        }
        if ($this->isColumnModified(SchoolEmploymentPeer::SCHOOL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`school_id`';
        }
        if ($this->isColumnModified(SchoolEmploymentPeer::SCHOOL_YEAR_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `school_employment` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SchoolEmploymentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SchoolEmploymentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SchoolEmployment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SchoolEmployment'][$this->getPrimaryKey()] = true;
        $keys = SchoolEmploymentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SchoolEmploymentPeer::ID)) $criteria->add(SchoolEmploymentPeer::ID, $this->id);
        if ($this->isColumnModified(SchoolEmploymentPeer::EMPLOYEE_ID)) $criteria->add(SchoolEmploymentPeer::EMPLOYEE_ID, $this->employee_id);
        if ($this->isColumnModified(SchoolEmploymentPeer::SCHOOL_ID)) $criteria->add(SchoolEmploymentPeer::SCHOOL_ID, $this->school_id);
        if ($this->isColumnModified(SchoolEmploymentPeer::SCHOOL_YEAR_ID)) $criteria->add(SchoolEmploymentPeer::SCHOOL_YEAR_ID, $this->school_year_id);
        if ($this->isColumnModified(SchoolEmploymentPeer::CREATED_AT)) $criteria->add(SchoolEmploymentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(SchoolEmploymentPeer::UPDATED_AT)) $criteria->add(SchoolEmploymentPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(SchoolEmploymentPeer::DATABASE_NAME);
        $criteria->add(SchoolEmploymentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of SchoolEmployment (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SchoolEmployment Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SchoolEmploymentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SchoolEmploymentPeer();
        }
    ...
    {
        if ($this->aEmployee === null && ($this->employee_id !== null) && $doQuery) {
            $this->aEmployee = EmployeeQuery::create()->findPk($this->employee_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEmployee->addSchoolEmployments($this);
             */
        }
    ...
    public function getSchool(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSchool === null && ($this->school_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSchool->addSchoolEmployments($this);
             */
        }
    ...
    public function getSchoolYear(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSchoolYear === null && ($this->school_year_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSchoolYear->addSchoolEmployments($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SchoolEmploymentPeer::DEFAULT_STRING_FORMAT);
    }
