...
abstract class BaseAcademicYear extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\AcademicYear\\AcademicYearPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        AcademicYearPeer
     */
    ...
    /**
     * The value for the year_start field.
     * Note: this column has a database default value of: 2010
     * @var        int
     */
     ...
     * Note: this column has a database default value of: 2011
     * @var        int
     */
    protected $year_end;
    ...
    {
        $this->year_start = 2010;
        $this->year_end = 2011;
        $this->active = false;
    }

    /**
     * Initializes internal state of BaseAcademicYear object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [year_start] column value.
     *
     * @return int
     */
     ...
     * @return AcademicYear The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AcademicYearPeer::ID;
        }
    ...
    /**
     * Set the value of [year_start] column.
     *
     * @param  int $v new value
     * @return AcademicYear The current object (for fluent API support)
     */
    public function setYearStart($v)
    {
        ...
        if ($this->year_start !== $v) {
            $this->year_start = $v;
            $this->modifiedColumns[] = AcademicYearPeer::YEAR_START;
        }
    ...
    /**
     * Set the value of [year_end] column.
     *
     * @param  int $v new value
     * @return AcademicYear The current object (for fluent API support)
     */
    public function setYearEnd($v)
    {
        ...
        if ($this->year_end !== $v) {
            $this->year_end = $v;
            $this->modifiedColumns[] = AcademicYearPeer::YEAR_END;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = AcademicYearPeer::DESCRIPTION;
        }
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = AcademicYearPeer::ACTIVE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AcademicYearPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AcademicYearPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    {
            if ($this->year_start !== 2010) {
                return false;
            }

            if ($this->year_end !== 2011) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->year_start = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->year_end = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 7; // 7 = AcademicYearPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AcademicYear object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AcademicYearPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = AcademicYearQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(AcademicYearPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(AcademicYearPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(AcademicYearPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                AcademicYearPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AcademicYearPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AcademicYearPeer::YEAR_START)) {
            $modifiedColumns[':p' . $index++]  = '`year_start`';
        }
        if ($this->isColumnModified(AcademicYearPeer::YEAR_END)) {
            $modifiedColumns[':p' . $index++]  = '`year_end`';
        }
        if ($this->isColumnModified(AcademicYearPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(AcademicYearPeer::ACTIVE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `academic_year` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`year_start`':
                        $stmt->bindValue($identifier, $this->year_start, PDO::PARAM_INT);
                        break;
                    case '`year_end`':
                        $stmt->bindValue($identifier, $this->year_end, PDO::PARAM_INT);
                        break;
                    case '`description`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AcademicYearPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AcademicYearPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AcademicYear'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AcademicYear'][$this->getPrimaryKey()] = true;
        $keys = AcademicYearPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getYearStart(),
            $keys[2] => $this->getYearEnd(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setYearStart($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setYearEnd($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AcademicYearPeer::ID)) $criteria->add(AcademicYearPeer::ID, $this->id);
        if ($this->isColumnModified(AcademicYearPeer::YEAR_START)) $criteria->add(AcademicYearPeer::YEAR_START, $this->year_start);
        if ($this->isColumnModified(AcademicYearPeer::YEAR_END)) $criteria->add(AcademicYearPeer::YEAR_END, $this->year_end);
        if ($this->isColumnModified(AcademicYearPeer::DESCRIPTION)) $criteria->add(AcademicYearPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(AcademicYearPeer::ACTIVE)) $criteria->add(AcademicYearPeer::ACTIVE, $this->active);
        if ($this->isColumnModified(AcademicYearPeer::CREATED_AT)) $criteria->add(AcademicYearPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(AcademicYearPeer::UPDATED_AT)) $criteria->add(AcademicYearPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(AcademicYearPeer::DATABASE_NAME);
        $criteria->add(AcademicYearPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of AcademicYear (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AcademicYear Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AcademicYearPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AcademicYearPeer();
        }
     ...
     * If this AcademicYear is new, it will return
    ...
    public function setSchoolYears(PropelCollection $schoolYears, PropelPDO $con = null)
    {
        ...
        foreach ($schoolYearsToDelete as $schoolYearRemoved) {
            $schoolYearRemoved->setAcademicYear(null);
        }
    ...
    protected function doAddSchoolYear($schoolYear)
    {
        ...
        $schoolYear->setAcademicYear($this);
    }
    ...
    public function removeSchoolYear($schoolYear)
    {
        if ($this->getSchoolYears()->contains($schoolYear)) {
            ...
            $schoolYear->setAcademicYear(null);
        }
     ...
     * Otherwise if this AcademicYear is new, it will return
     * an empty collection; or if this AcademicYear has previously
     * been saved, it will retrieve related SchoolYears from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in AcademicYear.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|SchoolYear[] List of SchoolYear objects
     */
    public function getSchoolYearsJoinSchool($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SchoolYearQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(AcademicYearPeer::DEFAULT_STRING_FORMAT);
    }
