...
abstract class BaseOrganizationArchive extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\Organization\\OrganizationArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OrganizationArchivePeer
     */
    ...
    /**
     * Initializes internal state of BaseOrganizationArchive object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::USER_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::NAME;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::URL;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::DESCRIPTION;
        }
    ...
    public function setExcerpt($v)
    {
        ...
        if ($this->excerpt !== $v) {
            $this->excerpt = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::EXCERPT;
        }
    ...
    public function setGovermentLicense($v)
    {
        ...
        if ($this->goverment_license !== $v) {
            ...
            $this->modifiedColumns[] = OrganizationArchivePeer::GOVERMENT_LICENSE;
        }
    ...
    public function setAddress1($v)
    {
        ...
        if ($this->address1 !== $v) {
            $this->address1 = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::ADDRESS1;
        }
    ...
    public function setAddress2($v)
    {
        ...
        if ($this->address2 !== $v) {
            $this->address2 = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::ADDRESS2;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::CITY;
        }
    ...
    public function setZipcode($v)
    {
        ...
        if ($this->zipcode !== $v) {
            $this->zipcode = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::ZIPCODE;
        }
    ...
    public function setCountryId($v)
    {
        ...
        if ($this->country_id !== $v) {
            $this->country_id = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::COUNTRY_ID;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::PHONE;
        }
    ...
    public function setFax($v)
    {
        ...
        if ($this->fax !== $v) {
            $this->fax = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::FAX;
        }
    ...
    public function setMobile($v)
    {
        ...
        if ($this->mobile !== $v) {
            $this->mobile = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::MOBILE;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::EMAIL;
        }
    ...
    public function setWebsite($v)
    {
        ...
        if ($this->website !== $v) {
            $this->website = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::WEBSITE;
        }
    ...
    public function setLogo($v)
    {
        ...
        if ($this->logo !== $v) {
            $this->logo = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::LOGO;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::STATUS;
        }
    ...
    public function setConfirmation($v)
    {
        ...
        if ($this->confirmation !== $v) {
            $this->confirmation = $v;
            $this->modifiedColumns[] = OrganizationArchivePeer::CONFIRMATION;
        }
    ...
    public function setSortableRank($v)
    {
        ...
        if ($this->sortable_rank !== $v) {
            ...
            $this->modifiedColumns[] = OrganizationArchivePeer::SORTABLE_RANK;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OrganizationArchivePeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OrganizationArchivePeer::ARCHIVED_AT;
            }
        } // if either are not null
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OrganizationArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = OrganizationArchiveQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                OrganizationArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OrganizationArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(OrganizationArchivePeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(OrganizationArchivePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(OrganizationArchivePeer::URL)) {
            $modifiedColumns[':p' . $index++]  = '`url`';
        }
        if ($this->isColumnModified(OrganizationArchivePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(OrganizationArchivePeer::EXCERPT)) {
        ...
        if ($this->isColumnModified(OrganizationArchivePeer::ADDRESS2)) {
        ...
        if ($this->isColumnModified(OrganizationArchivePeer::FAX)) {
            $modifiedColumns[':p' . $index++]  = '`fax`';
        }
        if ($this->isColumnModified(OrganizationArchivePeer::MOBILE)) {
            $modifiedColumns[':p' . $index++]  = '`mobile`';
        }
        if ($this->isColumnModified(OrganizationArchivePeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`email`';
        }
        if ($this->isColumnModified(OrganizationArchivePeer::WEBSITE)) {
            $modifiedColumns[':p' . $index++]  = '`website`';
        }
        if ($this->isColumnModified(OrganizationArchivePeer::LOGO)) {
        ...
        if ($this->isColumnModified(OrganizationArchivePeer::SORTABLE_RANK)) {
        ...
        if ($this->isColumnModified(OrganizationArchivePeer::ARCHIVED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`archived_at`';
        }

        $sql = sprintf(
            'INSERT INTO `organization_archive` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OrganizationArchivePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OrganizationArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OrganizationArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrganizationArchive'][$this->getPrimaryKey()] = true;
        $keys = OrganizationArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrganizationArchivePeer::ID)) $criteria->add(OrganizationArchivePeer::ID, $this->id);
        if ($this->isColumnModified(OrganizationArchivePeer::USER_ID)) $criteria->add(OrganizationArchivePeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(OrganizationArchivePeer::NAME)) $criteria->add(OrganizationArchivePeer::NAME, $this->name);
        if ($this->isColumnModified(OrganizationArchivePeer::URL)) $criteria->add(OrganizationArchivePeer::URL, $this->url);
        ...
        if ($this->isColumnModified(OrganizationArchivePeer::EMAIL)) $criteria->add(OrganizationArchivePeer::EMAIL, $this->email);
        ...
        if ($this->isColumnModified(OrganizationArchivePeer::UPDATED_AT)) $criteria->add(OrganizationArchivePeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(OrganizationArchivePeer::ARCHIVED_AT)) $criteria->add(OrganizationArchivePeer::ARCHIVED_AT, $this->archived_at);
    ...
    {
        $criteria = new Criteria(OrganizationArchivePeer::DATABASE_NAME);
        $criteria->add(OrganizationArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of OrganizationArchive (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OrganizationArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OrganizationArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OrganizationArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(OrganizationArchivePeer::DEFAULT_STRING_FORMAT);
    }
