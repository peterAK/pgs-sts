...
abstract class BaseBranch extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\Branch\\BranchPeer';
    ...
    /**
     * The value for the desscription field.
     * @var        string
     */
    ...
    /**
     * Get the [desscription] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [desscription] column.
     *
     * @param  string $v new value
     * @return Branch The current object (for fluent API support)
     */
    public function setDescription($v)
    {
        ...
        if ($this->desscription !== $v) {
            $this->desscription = $v;
            $this->modifiedColumns[] = BranchPeer::DESSCRIPTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = BranchPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BranchPeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(BranchPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(BranchPeer::DESSCRIPTION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BranchPeer::DESSCRIPTION)) $criteria->add(BranchPeer::DESSCRIPTION, $this->desscription);
