...
namespace PGS\CoreDomainBundle\Model\Branch\om;
...
use PGS\CoreDomainBundle\Model\Branch\Branch;
use PGS\CoreDomainBundle\Model\Branch\BranchPeer;
use PGS\CoreDomainBundle\Model\Branch\map\BranchTableMap;
...
abstract class BaseBranchPeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Branch\\Branch';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Branch\\map\\BranchTableMap';
    ...
    const DESSCRIPTION = 'branch.desscription';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (BranchPeer::ID, BranchPeer::CODE, BranchPeer::NAME, BranchPeer::DESSCRIPTION, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (BranchPeer::ID => 0, BranchPeer::CODE => 1, BranchPeer::NAME => 2, BranchPeer::DESSCRIPTION => 3, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BranchPeer::DESSCRIPTION);
        } else {
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = BranchPeer::getInstanceFromPool($key))) {
            ...
            $cls = BranchPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseBranchPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\Branch\map\BranchTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(BranchPeer::OM_CLASS, $row, $colnum);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\Branch\om\BaseBranchPeer'));
