...
use PGS\CoreDomainBundle\Model\Branch\BranchQuery;
 ...
 * @method BranchQuery orderByDescription($order = Criteria::ASC) Order by the desscription column
 *
 ...
 * @method BranchQuery groupByDescription() Group by the desscription column
 *
 ...
 * @method Branch findOneByDescription(string $desscription) Return the first Branch filtered by the desscription column
 *
 ...
 * @method array findByDescription(string $desscription) Return Branch objects filtered by the desscription column
 */
abstract class BaseBranchQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'PGS\\CoreDomainBundle\\Model\\Branch\\Branch';
        }
    ...
    {
        $sql = 'SELECT `id`, `code`, `name`, `desscription` FROM `branch` WHERE `id` = :p0';
        try {
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(BranchPeer::DESSCRIPTION, $description, $comparison);
    }
