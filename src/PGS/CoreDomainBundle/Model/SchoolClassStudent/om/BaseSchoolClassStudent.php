...
abstract class BaseSchoolClassStudent extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\SchoolClassStudent\\SchoolClassStudentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SchoolClassStudentPeer
     */
     ...
     * @return SchoolClassStudent The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SchoolClassStudentPeer::ID;
        }
    ...
    public function setStudentId($v)
    {
        ...
        if ($this->student_id !== $v) {
            $this->student_id = $v;
            $this->modifiedColumns[] = SchoolClassStudentPeer::STUDENT_ID;
        }
    ...
    public function setSchoolClassId($v)
    {
        ...
        if ($this->school_class_id !== $v) {
            ...
            $this->modifiedColumns[] = SchoolClassStudentPeer::SCHOOL_CLASS_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SchoolClassStudentPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SchoolClassStudentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = SchoolClassStudentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SchoolClassStudent object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SchoolClassStudentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = SchoolClassStudentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SchoolClassStudentPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(SchoolClassStudentPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SchoolClassStudentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                SchoolClassStudentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SchoolClassStudentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(SchoolClassStudentPeer::STUDENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`student_id`';
        }
        if ($this->isColumnModified(SchoolClassStudentPeer::SCHOOL_CLASS_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `school_class_student` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SchoolClassStudentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SchoolClassStudentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SchoolClassStudent'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SchoolClassStudent'][$this->getPrimaryKey()] = true;
        $keys = SchoolClassStudentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SchoolClassStudentPeer::ID)) $criteria->add(SchoolClassStudentPeer::ID, $this->id);
        if ($this->isColumnModified(SchoolClassStudentPeer::STUDENT_ID)) $criteria->add(SchoolClassStudentPeer::STUDENT_ID, $this->student_id);
        if ($this->isColumnModified(SchoolClassStudentPeer::SCHOOL_CLASS_ID)) $criteria->add(SchoolClassStudentPeer::SCHOOL_CLASS_ID, $this->school_class_id);
        if ($this->isColumnModified(SchoolClassStudentPeer::CREATED_AT)) $criteria->add(SchoolClassStudentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(SchoolClassStudentPeer::UPDATED_AT)) $criteria->add(SchoolClassStudentPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(SchoolClassStudentPeer::DATABASE_NAME);
        $criteria->add(SchoolClassStudentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of SchoolClassStudent (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SchoolClassStudent Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SchoolClassStudentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SchoolClassStudentPeer();
        }
    ...
    public function getStudent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aStudent === null && ($this->student_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aStudent->addSchoolClassStudents($this);
             */
        }
    ...
    public function getSchoolClass(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSchoolClass === null && ($this->school_class_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSchoolClass->addSchoolClassStudents($this);
             */
        }
     ...
     * If this SchoolClassStudent is new, it will return
        ...
        if (null === $this->collScores || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collScores) {
                ...
                $collScores = ScoreQuery::create(null, $criteria)
                    ->filterBySchoolClassStudent($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setScores(PropelCollection $scores, PropelPDO $con = null)
    {
        ...
        foreach ($scoresToDelete as $scoreRemoved) {
            $scoreRemoved->setSchoolClassStudent(null);
        }
    ...
    protected function doAddScore($score)
    {
        ...
        $score->setSchoolClassStudent($this);
    }
    ...
    public function removeScore($score)
    {
        if ($this->getScores()->contains($score)) {
            ...
            $score->setSchoolClassStudent(null);
        }
     ...
     * Otherwise if this SchoolClassStudent is new, it will return
     * an empty collection; or if this SchoolClassStudent has previously
     * been saved, it will retrieve related Scores from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SchoolClassStudent.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Score[] List of Score objects
     */
    public function getScoresJoinSchoolClassCourse($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ScoreQuery::create(null, $criteria);
    ...
    public function setStudentReports(PropelCollection $studentReports, PropelPDO $con = null)
    {
        ...
        foreach ($studentReportsToDelete as $studentReportRemoved) {
            $studentReportRemoved->setSchoolClassStudent(null);
        }
    ...
    protected function doAddStudentReport($studentReport)
    {
        ...
        $studentReport->setSchoolClassStudent($this);
    }
    ...
    public function removeStudentReport($studentReport)
    {
        if ($this->getStudentReports()->contains($studentReport)) {
            ...
            $studentReport->setSchoolClassStudent(null);
        }
    ...
    {
        return (string) $this->exportTo(SchoolClassStudentPeer::DEFAULT_STRING_FORMAT);
    }
