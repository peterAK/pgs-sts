...
abstract class BaseGroupQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'PGS\\CoreDomainBundle\\Model\\Group';
        }
    ...
    {
        $sql = 'SELECT `id`, `name`, `roles`, `created_at`, `updated_at` FROM `fos_group` WHERE `id` = :p0';
        try {
    ...
    public function filterByUserGroup($userGroup, $comparison = null)
    {
        if ($userGroup instanceof UserGroup) {
            return $this
                ->addUsingAlias(GroupPeer::ID, $userGroup->getFosGroupId(), $comparison);
