...
abstract class BaseLicense extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\LicensePeer';
    ...
    public function setDays($v)
    {
        ...
        if ($this->days !== $v) {
            $this->days = $v;
            $this->modifiedColumns[] = LicensePeer::DAYS;
        }
    ...
    public function setFee($v)
    {
        ...
        if ($this->fee !== $v) {
            $this->fee = $v;
            $this->modifiedColumns[] = LicensePeer::FEE;
        }
    ...
    public function setSalt($v)
    {
        ...
        if ($this->salt !== $v) {
            $this->salt = $v;
            $this->modifiedColumns[] = LicensePeer::SALT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->days = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->fee = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->licensePaymentsScheduledForDeletion !== null) {
                if (!$this->licensePaymentsScheduledForDeletion->isEmpty()) {
                    foreach ($this->licensePaymentsScheduledForDeletion as $licensePayment) {
                        // need to save related object because we set the relation to null
                        $licensePayment->save($con);
                    }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LicensePeer::DAYS)) {
            $modifiedColumns[':p' . $index++]  = '`days`';
        }
        if ($this->isColumnModified(LicensePeer::FEE)) {
            $modifiedColumns[':p' . $index++]  = '`fee`';
        }
        if ($this->isColumnModified(LicensePeer::SALT)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setDays($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setFee($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LicensePeer::DAYS)) $criteria->add(LicensePeer::DAYS, $this->days);
        if ($this->isColumnModified(LicensePeer::FEE)) $criteria->add(LicensePeer::FEE, $this->fee);
        if ($this->isColumnModified(LicensePeer::SALT)) $criteria->add(LicensePeer::SALT, $this->salt);
    ...
    public function setLicensePayments(PropelCollection $licensePayments, PropelPDO $con = null)
    {
        ...
        foreach ($licensePaymentsToDelete as $licensePaymentRemoved) {
            $licensePaymentRemoved->setLicense(null);
        }
    ...
    protected function doAddLicensePayment($licensePayment)
    {
        ...
        $licensePayment->setLicense($this);
    }
    ...
    public function removeLicensePayment($licensePayment)
    {
        if ($this->getLicensePayments()->contains($licensePayment)) {
            ...
            $this->licensePaymentsScheduledForDeletion[]= $licensePayment;
            $licensePayment->setLicense(null);
        }
     ...
     * @return PropelObjectCollection|LicensePayment[] List of LicensePayment objects
     */
    public function getLicensePaymentsJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LicensePaymentQuery::create(null, $criteria);
    ...
    public function setUserLicenses(PropelCollection $userLicenses, PropelPDO $con = null)
    {
        ...
        foreach ($userLicensesToDelete as $userLicenseRemoved) {
            $userLicenseRemoved->setLicense(null);
        }
