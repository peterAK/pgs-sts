...
abstract class BaseTopic extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\TopicPeer';
    ...
    public function getAccess()
    {
        ...
        $valueSet = TopicPeer::getValueSet(TopicPeer::ACCESS);
    ...
    public function setKey($v)
    {
        ...
        if ($this->key !== $v) {
            $this->key = $v;
            $this->modifiedColumns[] = TopicPeer::KEY;
        }
    ...
    public function setAccess($v)
    {
        ...
        if ($this->access !== $v) {
            $this->access = $v;
            $this->modifiedColumns[] = TopicPeer::ACCESS;
        }
    ...
    public function setTreeLeft($v)
    {
        ...
        if ($this->tree_left !== $v) {
            $this->tree_left = $v;
            $this->modifiedColumns[] = TopicPeer::TREE_LEFT;
        }
    ...
    public function setTreeRight($v)
    {
        ...
        if ($this->tree_right !== $v) {
            $this->tree_right = $v;
            $this->modifiedColumns[] = TopicPeer::TREE_RIGHT;
        }
    ...
    public function setTreeLevel($v)
    {
        ...
        if ($this->tree_level !== $v) {
            $this->tree_level = $v;
            $this->modifiedColumns[] = TopicPeer::TREE_LEVEL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 9; // 9 = TopicPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // nested_set behavior
            if ($this->isRoot()) {
                throw new PropelException('Deletion of a root node is disabled for nested sets. Use TopicPeer::deleteTree() instead to delete an entire tree');
            }
            ...
            if ($ret) {
                ...
                if ($this->isInTree()) {
                    ...
                    TopicPeer::shiftRLValues(-2, $this->getRightValue() + 1, null, $con);
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TopicPeer::KEY)) {
            $modifiedColumns[':p' . $index++]  = '`key`';
        }
        if ($this->isColumnModified(TopicPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(TopicPeer::ACCESS)) {
            $modifiedColumns[':p' . $index++]  = '`access`';
        }
        if ($this->isColumnModified(TopicPeer::TREE_LEFT)) {
            $modifiedColumns[':p' . $index++]  = '`tree_left`';
        }
        if ($this->isColumnModified(TopicPeer::TREE_RIGHT)) {
            $modifiedColumns[':p' . $index++]  = '`tree_right`';
        }
        if ($this->isColumnModified(TopicPeer::TREE_LEVEL)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TopicPeer::KEY)) $criteria->add(TopicPeer::KEY, $this->key);
        if ($this->isColumnModified(TopicPeer::TITLE)) $criteria->add(TopicPeer::TITLE, $this->title);
        if ($this->isColumnModified(TopicPeer::ACCESS)) $criteria->add(TopicPeer::ACCESS, $this->access);
        if ($this->isColumnModified(TopicPeer::TREE_LEFT)) $criteria->add(TopicPeer::TREE_LEFT, $this->tree_left);
        if ($this->isColumnModified(TopicPeer::TREE_RIGHT)) $criteria->add(TopicPeer::TREE_RIGHT, $this->tree_right);
        if ($this->isColumnModified(TopicPeer::TREE_LEVEL)) $criteria->add(TopicPeer::TREE_LEVEL, $this->tree_level);
     ...
     *
     * @param      Topic $node Propel node object
     * @return     bool
     */
     ...
     *
     * @param      Topic $parent
     * @return     Topic The current object, for fluid interface
     */
    ...
    public function getParent(PropelPDO $con = null)
    {
        if ($this->aNestedSetParent === null && $this->hasParent()) {
            $this->aNestedSetParent = TopicQuery::create()
                ->ancestorsOf($this)
                ->orderByLevel(true)
                ->findOne($con);
        }
    ...
    {
        if (!TopicPeer::isValid($this)) {
            return false;
        }

        return TopicQuery::create()
     ...
     * @return     void
     */
    public function addNestedSetChild($topic)
    {
    ...
    public function getChildren($criteria = null, PropelPDO $con = null)
    {
        if (null === $this->collNestedSetChildren || null !== $criteria) {
            if ($this->isLeaf() || ($this->isNew() && null === $this->collNestedSetChildren)) {
                ...
                $collNestedSetChildren = TopicQuery::create(null, $criteria)
                  ->childrenOf($this)
                  ->orderByBranch()
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function countChildren($criteria = null, PropelPDO $con = null)
    {
        if (null === $this->collNestedSetChildren || null !== $criteria) {
            if ($this->isLeaf() || ($this->isNew() && null === $this->collNestedSetChildren)) {
                ...
                return TopicQuery::create(null, $criteria)
                    ->childrenOf($this)
                    ->count($con);
            }
        } else {
    ...
    public function getFirstChild($query = null, PropelPDO $con = null)
    {
        if ($this->isLeaf()) {
            ...
            return TopicQuery::create(null, $query)
                ->childrenOf($this)
                ->orderByBranch()
                ->findOne($con);
        }
    ...
    public function getSiblings($includeNode = false, $query = null, PropelPDO $con = null)
    {
        if ($this->isRoot()) {
            return array();
             ...
             $query = TopicQuery::create(null, $query)
     ...
     *
     * @param      Topic $child	Propel object for child node
     *
     * @return     Topic The current Propel object
     */
    public function addChild(Topic $child)
    {
        if ($this->isNew()) {
            throw new PropelException('A Topic object must not be new to accept children.');
        }
     ...
     *
     * @param      Topic $parent	Propel object for parent node
     *
     * @return     Topic The current Propel object
     */
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A Topic object must not already be in the tree to be inserted. Use the moveToFirstChildOf() instead.');
        }
        ...
        $this->nestedSetQueries []= array(
            'callable'  => array('\\PGS\CoreDomainBundle\Model\\TopicPeer', 'makeRoomForLeaf'),
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A Topic object must not already be in the tree to be inserted. Use the moveToLastChildOf() instead.');
        }
     ...
     * are not persisted until the current object is saved.
     *
     * @param      Topic $sibling	Propel object for parent node
     *
     * @return     Topic The current Propel object
     */
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A Topic object must not already be in the tree to be inserted. Use the moveToPrevSiblingOf() instead.');
        }
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A Topic object must not already be in the tree to be inserted. Use the moveToNextSiblingOf() instead.');
        }
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A Topic object must be already in the tree to be moved. Use the insertAsFirstChildOf() instead.');
        }
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A Topic object must be already in the tree to be moved. Use the insertAsLastChildOf() instead.');
        }
        if ($parent->isDescendantOf($this)) {
            throw new PropelException('Cannot move a node as child of one of its subtree nodes.');
        }
     ...
     * The modifications in the current object and the tree are immediate
     *
     * @param      Topic $sibling	Propel object for sibling node
     * @param      PropelPDO $con	Connection to use.
     *
     * @return     Topic The current Propel object
     */
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A Topic object must be already in the tree to be moved. Use the insertAsPrevSiblingOf() instead.');
        }
        if ($sibling->isRoot()) {
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A Topic object must be already in the tree to be moved. Use the insertAsNextSiblingOf() instead.');
        }
        if ($sibling->isRoot()) {
    ...
    protected function moveSubtreeTo($destLeft, $levelDelta, PropelPDO $con = null)
    {
        ...
        try {
            ...
            TopicPeer::shiftRLValues($treeSize, $destLeft, null, $con);
            ...
            if (!$preventDefault) {
                ...
                if ($levelDelta) {
                    ...
                    TopicPeer::shiftLevel($levelDelta, $left, $right, $con);
                }

                // move the subtree to the target
                TopicPeer::shiftRLValues($destLeft - $left, $left, $right, $con);
            }

            // remove the empty room at the previous location of the subtree
            TopicPeer::shiftRLValues(-$treeSize, $right + 1, null, $con);

            // update all loaded nodes
            TopicPeer::updateLoadedNodes(null, $con);
     ...
     * so existing Topic instances are probably invalid (except for the current one)
     *
     * @param      PropelPDO $con Connection to use.
     *
    ...
    public function deleteDescendants(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $ret = TopicQuery::create()
                ->descendantsOf($this)
                ->delete($con);

            // fill up the room that was used by descendants
            TopicPeer::shiftRLValues($left - $right + 1, $right, null, $con);
