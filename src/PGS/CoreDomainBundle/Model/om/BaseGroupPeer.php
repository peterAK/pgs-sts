...
use PGS\CoreDomainBundle\Model\map\GroupTableMap;
...
abstract class BaseGroupPeer
{
    ...
    const TABLE_NAME = 'fos_group';

    /** the related Propel class for this table */
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Group';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to fos_group
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = GroupPeer::getInstanceFromPool($key))) {
            ...
            $cls = GroupPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseGroupPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\map\GroupTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(GroupPeer::OM_CLASS, $row, $colnum);
    ...
    /**
     * Deletes all rows from the fos_group table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\om\BaseGroupPeer'));
