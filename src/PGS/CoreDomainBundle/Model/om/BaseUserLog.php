...
abstract class BaseUserLog extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\UserLogPeer';
    ...
    public function setIpSource($v)
    {
        ...
        if ($this->ip_source !== $v) {
            $this->ip_source = $v;
            $this->modifiedColumns[] = UserLogPeer::IP_SOURCE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->ip_source = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 5; // 5 = UserLogPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserLogPeer::IP_SOURCE)) {
            $modifiedColumns[':p' . $index++]  = '`ip_source`';
        }
        if ($this->isColumnModified(UserLogPeer::CREATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`user_id`':
                        ...
                        break;
                    case '`ip_source`':
                        $stmt->bindValue($identifier, $this->ip_source, PDO::PARAM_STR);
                        break;
                    case '`created_at`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setIpSource($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserLogPeer::IP_SOURCE)) $criteria->add(UserLogPeer::IP_SOURCE, $this->ip_source);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIpSource($this->getIpSource());
    ...
    public function __call($name, $params)
    {
        ...
        if (is_callable(array('PGS\CoreDomainBundle\Model\User', $name))) {
