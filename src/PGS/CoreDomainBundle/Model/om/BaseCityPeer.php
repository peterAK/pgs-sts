...
use PGS\CoreDomainBundle\Model\map\CityTableMap;
...
abstract class BaseCityPeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\City';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PGS\\CoreDomainBundle\\Model\\map\\CityTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of City objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Code', 'Name', 'StateId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'code', 'name', 'stateId', ),
        BasePeer::TYPE_COLNAME => array (CityPeer::ID, CityPeer::CODE, CityPeer::NAME, CityPeer::STATE_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CODE', 'NAME', 'STATE_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'name', 'state_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Code' => 1, 'Name' => 2, 'StateId' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'code' => 1, 'name' => 2, 'stateId' => 3, ),
        BasePeer::TYPE_COLNAME => array (CityPeer::ID => 0, CityPeer::CODE => 1, CityPeer::NAME => 2, CityPeer::STATE_ID => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CODE' => 1, 'NAME' => 2, 'STATE_ID' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code' => 1, 'name' => 2, 'state_id' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = CityPeer::getInstanceFromPool($key))) {
            ...
            $cls = CityPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    public static function doCountJoinState(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CityPeer::STATE_ID, StatePeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of City objects pre-filled with their State objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinState(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (City) to $obj2 (State)
                $obj2->addCity($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (City) to the collection in $obj2 (State)
                $obj2->addCity($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCityPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\map\CityTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(CityPeer::OM_CLASS, $row, $colnum);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\om\BaseCityPeer'));
