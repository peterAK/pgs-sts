...
abstract class BaseStatePeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\State';
    ...
    /**
     * An identity map to hold any loaded instances of State objects.
    ...
    {
        $toNames = StatePeer::getFieldNames($toType);
        $key = isset(StatePeer::$fieldKeys[$fromType][$name]) ? StatePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(StatePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, StatePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return StatePeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(StatePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(StatePeer::DATABASE_NAME);
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(StatePeer::$instances[$key])) {
                return StatePeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (StatePeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        StatePeer::$instances = array();
    }
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = StatePeer::getInstanceFromPool($key))) {
            ...
            $cls = StatePeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    {
        return Propel::getDatabaseMap(StatePeer::DATABASE_NAME)->getTable(StatePeer::TABLE_NAME);
    }
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseStatePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\map\StateTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(StatePeer::OM_CLASS, $row, $colnum);
        EventDispatcherProxy::trigger('om.detect', $event);
        if($event->isDetected()){
            return $event->getDetectedClass();
        }

        return StatePeer::OM_CLASS;
    }
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\om\BaseStatePeer'));
