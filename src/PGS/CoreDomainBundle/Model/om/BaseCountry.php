...
abstract class BaseCountry extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\CountryPeer';
    ...
    public function setDescription($v)
    {
        ...
        if ($this->desscription !== $v) {
            $this->desscription = $v;
            $this->modifiedColumns[] = CountryPeer::DESSCRIPTION;
        }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->statesScheduledForDeletion !== null) {
                if (!$this->statesScheduledForDeletion->isEmpty()) {
                    foreach ($this->statesScheduledForDeletion as $state) {
    ...
    public function setUserProfiles(PropelCollection $userProfiles, PropelPDO $con = null)
    {
        ...
        foreach ($userProfilesToDelete as $userProfileRemoved) {
            $userProfileRemoved->setCountry(null);
        }
     ...
     * @return PropelObjectCollection|UserProfile[] List of UserProfile objects
     */
    public function getUserProfilesJoinPrincipal($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UserProfileQuery::create(null, $criteria);
        $query->joinWith('Principal', $join_behavior);
