...
abstract class BaseRegion extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\RegionPeer';
    ...
    public function setBranchCoverages(PropelCollection $branchCoverages, PropelPDO $con = null)
    {
        ...
        foreach ($branchCoveragesToDelete as $branchCoverageRemoved) {
            $branchCoverageRemoved->setRegion(null);
        }
