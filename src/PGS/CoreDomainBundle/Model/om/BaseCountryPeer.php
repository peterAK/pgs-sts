...
abstract class BaseCountryPeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Country';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = CountryPeer::getInstanceFromPool($key))) {
            ...
            $cls = CountryPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCountryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\map\CountryTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(CountryPeer::OM_CLASS, $row, $colnum);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\om\BaseCountryPeer'));
