...
use PGS\CoreDomainBundle\Model\map\RegionTableMap;
...
abstract class BaseRegionPeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Region';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PGS\\CoreDomainBundle\\Model\\map\\RegionTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of Region objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID, RegionPeer::CODE, RegionPeer::NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID => 0, RegionPeer::CODE => 1, RegionPeer::NAME => 2, ),
    ...
    {
        // Invalidate objects in BranchCoveragePeer instance pool,
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = RegionPeer::getInstanceFromPool($key))) {
            ...
            $cls = RegionPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseRegionPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\map\RegionTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(RegionPeer::OM_CLASS, $row, $colnum);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\om\BaseRegionPeer'));
