 ...
 *
 * @method RegionQuery leftJoinBranchCoverage($relationAlias = null) Adds a LEFT JOIN clause to the query using the BranchCoverage relation
 * @method RegionQuery rightJoinBranchCoverage($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BranchCoverage relation
 * @method RegionQuery innerJoinBranchCoverage($relationAlias = null) Adds a INNER JOIN clause to the query using the BranchCoverage relation
 *
 * @method RegionQuery leftJoinStore($relationAlias = null) Adds a LEFT JOIN clause to the query using the Store relation
 * @method RegionQuery rightJoinStore($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Store relation
 * @method RegionQuery innerJoinStore($relationAlias = null) Adds a INNER JOIN clause to the query using the Store relation
 *
...
abstract class BaseRegionQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'PGS\\CoreDomainBundle\\Model\\Region';
        }
    ...
    {
        $sql = 'SELECT `id`, `code`, `name` FROM `region` WHERE `id` = :p0';
        try {
    ...
    public function filterByBranchCoverage($branchCoverage, $comparison = null)
    {
        if ($branchCoverage instanceof BranchCoverage) {
            return $this
                ->addUsingAlias(RegionPeer::ID, $branchCoverage->getRegionId(), $comparison);
    ...
    public function filterByStore($store, $comparison = null)
    {
        if ($store instanceof Store) {
            return $this
                ->addUsingAlias(RegionPeer::ID, $store->getRegionId(), $comparison);
