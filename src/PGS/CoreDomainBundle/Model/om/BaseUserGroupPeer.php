...
use PGS\CoreDomainBundle\Model\GroupPeer;
use PGS\CoreDomainBundle\Model\UserGroup;
use PGS\CoreDomainBundle\Model\UserGroupPeer;
use PGS\CoreDomainBundle\Model\UserPeer;
use PGS\CoreDomainBundle\Model\map\UserGroupTableMap;
...
abstract class BaseUserGroupPeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\UserGroup';
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getFosUserId(), (string) $obj->getFosGroupId()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof UserGroup) {
                $key = serialize(array((string) $value->getFosUserId(), (string) $value->getFosGroupId()));
    ...
    /**
     * Method to invalidate the instance pool of all tables related to fos_user_group
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = UserGroupPeer::getInstanceFromPool($key))) {
            ...
            $cls = UserGroupPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserGroupPeer::FOS_USER_ID, UserPeer::ID, $join_behavior);
    ...
    public static function doCountJoinGroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserGroupPeer::FOS_GROUP_ID, GroupPeer::ID, $join_behavior);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserGroupPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\map\UserGroupTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(UserGroupPeer::OM_CLASS, $row, $colnum);
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(UserGroupPeer::FOS_USER_ID);
            $value = $criteria->remove(UserGroupPeer::FOS_USER_ID);
            if ($value) {
                $selectCriteria->add(UserGroupPeer::FOS_USER_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(UserGroupPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(UserGroupPeer::FOS_GROUP_ID);
            $value = $criteria->remove(UserGroupPeer::FOS_GROUP_ID);
            if ($value) {
                $selectCriteria->add(UserGroupPeer::FOS_GROUP_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(UserGroupPeer::TABLE_NAME);
            }
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(UserGroupPeer::FOS_USER_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(UserGroupPeer::FOS_GROUP_ID, $value[1]));
     ...
     * @param   int $fos_user_id
     * @param   int $fos_group_id
     * @param      PropelPDO $con
     * @return UserGroup
     */
    public static function retrieveByPK($fos_user_id, $fos_group_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $fos_user_id, (string) $fos_group_id));
        ...
        $criteria = new Criteria(UserGroupPeer::DATABASE_NAME);
        $criteria->add(UserGroupPeer::FOS_USER_ID, $fos_user_id);
        $criteria->add(UserGroupPeer::FOS_GROUP_ID, $fos_group_id);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\om\BaseUserGroupPeer'));
