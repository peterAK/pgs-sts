...
/**
 * @method HelpI18nQuery orderById($order = Criteria::ASC) Order by the id column
 ...
 * @method HelpI18nQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method HelpI18nQuery leftJoinHelp($relationAlias = null) Adds a LEFT JOIN clause to the query using the Help relation
 * @method HelpI18nQuery rightJoinHelp($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Help relation
 * @method HelpI18nQuery innerJoinHelp($relationAlias = null) Adds a INNER JOIN clause to the query using the Help relation
 *
 * @method HelpI18n findOne(PropelPDO $con = null) Return the first HelpI18n matching the query
 * @method HelpI18n findOneOrCreate(PropelPDO $con = null) Return the first HelpI18n matching the query, or a new HelpI18n object populated from the query conditions when no match is found
 *
 * @method HelpI18n findOneById(int $id) Return the first HelpI18n filtered by the id column
...
{
    /**
     * Initializes internal state of BaseHelpI18nQuery object.
     *
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'PGS\\CoreDomainBundle\\Model\\HelpI18n';
        }
    ...
    /**
     * Returns a new HelpI18nQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param   HelpI18nQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return HelpI18nQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof HelpI18nQuery) {
            return $criteria;
        }
     ...
     *
     * @return   HelpI18n|HelpI18n[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = HelpI18nPeer::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && !$this->formatter) {
     ...
     *
     * @return                 HelpI18n A model object, or null if the key is not found
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $obj = new $cls;
            $obj->hydrate($row);
            HelpI18nPeer::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|HelpI18n[]|mixed the list of results, formatted by the current formatter
     */
    ...
    {
        $this->addUsingAlias(HelpI18nPeer::ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(HelpI18nPeer::LOCALE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(HelpI18nPeer::ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(HelpI18nPeer::LOCALE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(HelpI18nPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(HelpI18nPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(HelpI18nPeer::ID, $id, $comparison);
    }
    ...
    public function filterByLocale($locale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(HelpI18nPeer::LOCALE, $locale, $comparison);
    }
    ...
    public function filterByTitle($title = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(HelpI18nPeer::TITLE, $title, $comparison);
    }
    ...
    public function filterByContent($content = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(HelpI18nPeer::CONTENT, $content, $comparison);
    }
    ...
    public function filterByHelp($help, $comparison = null)
    {
        if ($help instanceof Help) {
            return $this
                ->addUsingAlias(HelpI18nPeer::ID, $help->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(HelpI18nPeer::ID, $help->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    /**
     * Adds a JOIN clause to the query using the Help relation
     *
     ...
     * @return HelpI18nQuery The current query, for fluid interface
     */
    public function joinHelp($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('Help');
    ...
    /**
     * Use the Help relation Help object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \PGS\CoreDomainBundle\Model\HelpQuery A secondary query class using the current class as primary query
     */
    public function useHelpQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinHelp($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Help', '\PGS\CoreDomainBundle\Model\HelpQuery');
    }
