...
abstract class BaseSite extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\SitePeer';
    ...
    public function setMetaKey($v)
    {
        ...
        if ($this->meta_key !== $v) {
            $this->meta_key = $v;
            $this->modifiedColumns[] = SitePeer::META_KEY;
        }
    ...
    public function setMetaValue($v)
    {
        ...
        if ($this->meta_value !== $v) {
            $this->meta_value = $v;
            $this->modifiedColumns[] = SitePeer::META_VALUE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SitePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SitePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->meta_key = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->meta_value = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SitePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(SitePeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SitePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SitePeer::META_KEY)) {
            $modifiedColumns[':p' . $index++]  = '`meta_key`';
        }
        if ($this->isColumnModified(SitePeer::META_VALUE)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setMetaValue($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SitePeer::META_KEY)) $criteria->add(SitePeer::META_KEY, $this->meta_key);
        if ($this->isColumnModified(SitePeer::META_VALUE)) $criteria->add(SitePeer::META_VALUE, $this->meta_value);
        if ($this->isColumnModified(SitePeer::CREATED_AT)) $criteria->add(SitePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(SitePeer::UPDATED_AT)) $criteria->add(SitePeer::UPDATED_AT, $this->updated_at);
