 ...
 * @method AreaQuery orderByZipCode($order = Criteria::ASC) Order by the zip_code column
 * @method AreaQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method AreaQuery orderByStateId($order = Criteria::ASC) Order by the state_id column
 * @method AreaQuery orderByCityId($order = Criteria::ASC) Order by the city_id column
 *
 * @method AreaQuery groupById() Group by the id column
 * @method AreaQuery groupByCode() Group by the code column
 * @method AreaQuery groupByZipCode() Group by the zip_code column
 * @method AreaQuery groupByName() Group by the name column
 * @method AreaQuery groupByStateId() Group by the state_id column
 * @method AreaQuery groupByCityId() Group by the city_id column
 *
 ...
 *
 * @method AreaQuery leftJoinState($relationAlias = null) Adds a LEFT JOIN clause to the query using the State relation
 * @method AreaQuery rightJoinState($relationAlias = null) Adds a RIGHT JOIN clause to the query using the State relation
 * @method AreaQuery innerJoinState($relationAlias = null) Adds a INNER JOIN clause to the query using the State relation
 *
 ...
 *
 * @method AreaQuery leftJoinAreaAssignment($relationAlias = null) Adds a LEFT JOIN clause to the query using the AreaAssignment relation
 * @method AreaQuery rightJoinAreaAssignment($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AreaAssignment relation
 * @method AreaQuery innerJoinAreaAssignment($relationAlias = null) Adds a INNER JOIN clause to the query using the AreaAssignment relation
 *
 * @method AreaQuery leftJoinStore($relationAlias = null) Adds a LEFT JOIN clause to the query using the Store relation
 * @method AreaQuery rightJoinStore($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Store relation
 * @method AreaQuery innerJoinStore($relationAlias = null) Adds a INNER JOIN clause to the query using the Store relation
 *
 ...
 * @method Area findOneByZipCode(string $zip_code) Return the first Area filtered by the zip_code column
 * @method Area findOneByName(string $name) Return the first Area filtered by the name column
 * @method Area findOneByStateId(int $state_id) Return the first Area filtered by the state_id column
 * @method Area findOneByCityId(int $city_id) Return the first Area filtered by the city_id column
 *
 ...
 * @method array findByZipCode(string $zip_code) Return Area objects filtered by the zip_code column
 * @method array findByName(string $name) Return Area objects filtered by the name column
 * @method array findByStateId(int $state_id) Return Area objects filtered by the state_id column
 * @method array findByCityId(int $city_id) Return Area objects filtered by the city_id column
 */
abstract class BaseAreaQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'PGS\\CoreDomainBundle\\Model\\Area';
        }
    ...
    {
        $sql = 'SELECT `id`, `code`, `zip_code`, `name`, `state_id`, `city_id` FROM `area` WHERE `id` = :p0';
        try {
    ...
    public function filterByZipCode($zipCode = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AreaPeer::ZIP_CODE, $zipCode, $comparison);
    }
    ...
    public function filterByStateId($stateId = null, $comparison = null)
    {
        if (is_array($stateId)) {
            ...
            if (isset($stateId['min'])) {
                $this->addUsingAlias(AreaPeer::STATE_ID, $stateId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($stateId['max'])) {
                $this->addUsingAlias(AreaPeer::STATE_ID, $stateId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AreaPeer::STATE_ID, $stateId, $comparison);
    }
    ...
    public function filterByCityId($cityId = null, $comparison = null)
    {
        if (is_array($cityId)) {
            $useMinMax = false;
            if (isset($cityId['min'])) {
                $this->addUsingAlias(AreaPeer::CITY_ID, $cityId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($cityId['max'])) {
                $this->addUsingAlias(AreaPeer::CITY_ID, $cityId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AreaPeer::CITY_ID, $cityId, $comparison);
    }
    ...
    public function filterByState($state, $comparison = null)
    {
        if ($state instanceof State) {
            return $this
                ->addUsingAlias(AreaPeer::STATE_ID, $state->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AreaPeer::STATE_ID, $state->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCity($city, $comparison = null)
    {
        if ($city instanceof City) {
            return $this
                ->addUsingAlias(AreaPeer::CITY_ID, $city->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AreaPeer::CITY_ID, $city->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByAreaAssignment($areaAssignment, $comparison = null)
    {
        if ($areaAssignment instanceof AreaAssignment) {
            return $this
                ->addUsingAlias(AreaPeer::ID, $areaAssignment->getAreaId(), $comparison);
    ...
    public function filterByStore($store, $comparison = null)
    {
        if ($store instanceof Store) {
            return $this
                ->addUsingAlias(AreaPeer::ID, $store->getAreaId(), $comparison);
