...
use PGS\CoreDomainBundle\Model\map\AreaTableMap;
...
abstract class BaseAreaPeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Area';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PGS\\CoreDomainBundle\\Model\\map\\AreaTableMap';
    ...
    const ZIP_CODE = 'area.zip_code';

    /** the column name for the name field */
    const NAME = 'area.name';

    /** the column name for the state_id field */
    const STATE_ID = 'area.state_id';

    /** the column name for the city_id field */
    const CITY_ID = 'area.city_id';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Area objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Code', 'ZipCode', 'Name', 'StateId', 'CityId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'code', 'zipCode', 'name', 'stateId', 'cityId', ),
        BasePeer::TYPE_COLNAME => array (AreaPeer::ID, AreaPeer::CODE, AreaPeer::ZIP_CODE, AreaPeer::NAME, AreaPeer::STATE_ID, AreaPeer::CITY_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CODE', 'ZIP_CODE', 'NAME', 'STATE_ID', 'CITY_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'zip_code', 'name', 'state_id', 'city_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Code' => 1, 'ZipCode' => 2, 'Name' => 3, 'StateId' => 4, 'CityId' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'code' => 1, 'zipCode' => 2, 'name' => 3, 'stateId' => 4, 'cityId' => 5, ),
        BasePeer::TYPE_COLNAME => array (AreaPeer::ID => 0, AreaPeer::CODE => 1, AreaPeer::ZIP_CODE => 2, AreaPeer::NAME => 3, AreaPeer::STATE_ID => 4, AreaPeer::CITY_ID => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CODE' => 1, 'ZIP_CODE' => 2, 'NAME' => 3, 'STATE_ID' => 4, 'CITY_ID' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code' => 1, 'zip_code' => 2, 'name' => 3, 'state_id' => 4, 'city_id' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AreaPeer::ZIP_CODE);
            $criteria->addSelectColumn(AreaPeer::NAME);
            $criteria->addSelectColumn(AreaPeer::STATE_ID);
            $criteria->addSelectColumn(AreaPeer::CITY_ID);
        } else {
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = AreaPeer::getInstanceFromPool($key))) {
            ...
            $cls = AreaPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    public static function doCountJoinState(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(AreaPeer::STATE_ID, StatePeer::ID, $join_behavior);
    ...
    public static function doCountJoinCity(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(AreaPeer::CITY_ID, CityPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Area objects pre-filled with their State objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinState(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Area) to $obj2 (State)
                $obj2->addArea($obj1);
    ...
    /**
     * Selects a collection of Area objects pre-filled with their City objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Area objects.
    ...
    public static function doSelectJoinCity(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Area) to $obj2 (City)
                $obj2->addArea($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Area) to the collection in $obj2 (State)
                $obj2->addArea($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Area) to the collection in $obj3 (City)
                $obj3->addArea($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Area objects pre-filled with all related objects except State.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptState(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = AreaPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Area) to the collection in $obj2 (City)
                $obj2->addArea($obj1);
    ...
    /**
     * Selects a collection of Area objects pre-filled with all related objects except City.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseAreaPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\map\AreaTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(AreaPeer::OM_CLASS, $row, $colnum);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\om\BaseAreaPeer'));
