...
use PGS\CoreDomainBundle\Model\map\SiteTableMap;
...
abstract class BaseSitePeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Site';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PGS\\CoreDomainBundle\\Model\\map\\SiteTableMap';
    ...
    const META_KEY = 'site.meta_key';

    /** the column name for the meta_value field */
    const META_VALUE = 'site.meta_value';

    /** the column name for the created_at field */
    const CREATED_AT = 'site.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'site.updated_at';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'MetaKey', 'MetaValue', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'metaKey', 'metaValue', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (SitePeer::ID, SitePeer::META_KEY, SitePeer::META_VALUE, SitePeer::CREATED_AT, SitePeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'META_KEY', 'META_VALUE', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'meta_key', 'meta_value', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'MetaKey' => 1, 'MetaValue' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'metaKey' => 1, 'metaValue' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        BasePeer::TYPE_COLNAME => array (SitePeer::ID => 0, SitePeer::META_KEY => 1, SitePeer::META_VALUE => 2, SitePeer::CREATED_AT => 3, SitePeer::UPDATED_AT => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'META_KEY' => 1, 'META_VALUE' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'meta_key' => 1, 'meta_value' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SitePeer::META_KEY);
            $criteria->addSelectColumn(SitePeer::META_VALUE);
            $criteria->addSelectColumn(SitePeer::CREATED_AT);
            $criteria->addSelectColumn(SitePeer::UPDATED_AT);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseSitePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\map\SiteTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(SitePeer::OM_CLASS, $row, $colnum);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\om\BaseSitePeer'));
