...
abstract class BaseSchoolGradeLevel extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\SchoolGradeLevel\\SchoolGradeLevelPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SchoolGradeLevelPeer
     */
     ...
     * @return SchoolGradeLevel The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SchoolGradeLevelPeer::ID;
        }
    ...
    public function setSchoolId($v)
    {
        ...
        if ($this->school_id !== $v) {
            $this->school_id = $v;
            $this->modifiedColumns[] = SchoolGradeLevelPeer::SCHOOL_ID;
        }
    ...
    public function setGradeLevelId($v)
    {
        ...
        if ($this->grade_level_id !== $v) {
            ...
            $this->modifiedColumns[] = SchoolGradeLevelPeer::GRADE_LEVEL_ID;
        }
    ...
    public function setSortableRank($v)
    {
        ...
        if ($this->sortable_rank !== $v) {
            ...
            $this->modifiedColumns[] = SchoolGradeLevelPeer::SORTABLE_RANK;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SchoolGradeLevelPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SchoolGradeLevelPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = SchoolGradeLevelPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SchoolGradeLevel object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SchoolGradeLevelPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = SchoolGradeLevelQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // sortable behavior

            SchoolGradeLevelPeer::shiftRank(-1, $this->getSortableRank() + 1, null, $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // sortable behavior
                if (!$this->isColumnModified(SchoolGradeLevelPeer::RANK_COL)) {
                    $this->setSortableRank(SchoolGradeLevelQuery::create()->getMaxRankArray($con) + 1);
                }

                // timestampable behavior
                if (!$this->isColumnModified(SchoolGradeLevelPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(SchoolGradeLevelPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SchoolGradeLevelPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                SchoolGradeLevelPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SchoolGradeLevelPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(SchoolGradeLevelPeer::SCHOOL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`school_id`';
        }
        if ($this->isColumnModified(SchoolGradeLevelPeer::GRADE_LEVEL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`grade_level_id`';
        }
        if ($this->isColumnModified(SchoolGradeLevelPeer::SORTABLE_RANK)) {
        ...
        $sql = sprintf(
            'INSERT INTO `school_grade_level` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SchoolGradeLevelPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SchoolGradeLevelPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SchoolGradeLevel'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SchoolGradeLevel'][$this->getPrimaryKey()] = true;
        $keys = SchoolGradeLevelPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SchoolGradeLevelPeer::ID)) $criteria->add(SchoolGradeLevelPeer::ID, $this->id);
        if ($this->isColumnModified(SchoolGradeLevelPeer::SCHOOL_ID)) $criteria->add(SchoolGradeLevelPeer::SCHOOL_ID, $this->school_id);
        if ($this->isColumnModified(SchoolGradeLevelPeer::GRADE_LEVEL_ID)) $criteria->add(SchoolGradeLevelPeer::GRADE_LEVEL_ID, $this->grade_level_id);
        if ($this->isColumnModified(SchoolGradeLevelPeer::SORTABLE_RANK)) $criteria->add(SchoolGradeLevelPeer::SORTABLE_RANK, $this->sortable_rank);
        if ($this->isColumnModified(SchoolGradeLevelPeer::CREATED_AT)) $criteria->add(SchoolGradeLevelPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(SchoolGradeLevelPeer::UPDATED_AT)) $criteria->add(SchoolGradeLevelPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(SchoolGradeLevelPeer::DATABASE_NAME);
        $criteria->add(SchoolGradeLevelPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of SchoolGradeLevel (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SchoolGradeLevel Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SchoolGradeLevelPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SchoolGradeLevelPeer();
        }
    ...
    public function getSchool(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSchool === null && ($this->school_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSchool->addSchoolGradeLevels($this);
             */
        }
    ...
    public function getGradeLevel(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aGradeLevel === null && ($this->grade_level_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGradeLevel->addSchoolGradeLevels($this);
             */
        }
     ...
     * If this SchoolGradeLevel is new, it will return
    ...
    public function setSchoolClassCourses(PropelCollection $schoolClassCourses, PropelPDO $con = null)
    {
        ...
        foreach ($schoolClassCoursesToDelete as $schoolClassCourseRemoved) {
            $schoolClassCourseRemoved->setSchoolGradeLevel(null);
        }
    ...
    protected function doAddSchoolClassCourse($schoolClassCourse)
    {
        ...
        $schoolClassCourse->setSchoolGradeLevel($this);
    }
    ...
    public function removeSchoolClassCourse($schoolClassCourse)
    {
        if ($this->getSchoolClassCourses()->contains($schoolClassCourse)) {
            ...
            $schoolClassCourse->setSchoolGradeLevel(null);
        }
     ...
     * Otherwise if this SchoolGradeLevel is new, it will return
     * an empty collection; or if this SchoolGradeLevel has previously
     * been saved, it will retrieve related SchoolClassCourses from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SchoolGradeLevel.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(SchoolGradeLevelPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    {
        return $this->getSortableRank() == SchoolGradeLevelQuery::create()->getMaxRankArray($con);
    }
    ...
    public function getNext(PropelPDO $con = null)
    {
        ...
        $query = SchoolGradeLevelQuery::create();
     ...
     * @param     PropelPDO  $con      optional connection
     *
     * @return    SchoolGradeLevel the current object
     *
     * @throws    PropelException
     */
    public function insertAtRank($rank, PropelPDO $con = null)
    {
        $maxRank = SchoolGradeLevelQuery::create()->getMaxRankArray($con);
    ...
    public function moveToRank($newRank, PropelPDO $con = null)
    {
        ...
        if ($newRank < 1 || $newRank > SchoolGradeLevelQuery::create()->getMaxRankArray($con)) {
        ...
        try {
            ...
            SchoolGradeLevelPeer::shiftRank($delta, min($oldRank, $newRank), max($oldRank, $newRank), $con);
    ...
    public function moveToBottom(PropelPDO $con = null)
    {
        ...
        $con->beginTransaction();
        try {
            $bottom = SchoolGradeLevelQuery::create()->getMaxRankArray($con);
