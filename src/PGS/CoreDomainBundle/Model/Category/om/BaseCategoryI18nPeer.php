...
use PGS\CoreDomainBundle\Model\Category\map\CategoryI18nTableMap;
...
abstract class BaseCategoryI18nPeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Category\\CategoryI18n';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Category\\map\\CategoryI18nTableMap';
    ...
    const CREATED_AT = 'category_i18n.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'category_i18n.updated_at';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of CategoryI18n objects.
     ...
     * e.g. CategoryI18nPeer::$fieldNames[CategoryI18nPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (CategoryI18nPeer::ID, CategoryI18nPeer::LOCALE, CategoryI18nPeer::NAME, CategoryI18nPeer::DESCRIPTION, CategoryI18nPeer::CREATED_AT, CategoryI18nPeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (CategoryI18nPeer::ID => 0, CategoryI18nPeer::LOCALE => 1, CategoryI18nPeer::NAME => 2, CategoryI18nPeer::DESCRIPTION => 3, CategoryI18nPeer::CREATED_AT => 4, CategoryI18nPeer::UPDATED_AT => 5, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryI18nPeer::CREATED_AT);
            $criteria->addSelectColumn(CategoryI18nPeer::UPDATED_AT);
        } else {
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = CategoryI18nPeer::getInstanceFromPool($key))) {
            ...
            $cls = CategoryI18nPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCategoryI18nPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\Category\map\CategoryI18nTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(CategoryI18nPeer::OM_CLASS, $row, $colnum);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\Category\om\BaseCategoryI18nPeer'));
