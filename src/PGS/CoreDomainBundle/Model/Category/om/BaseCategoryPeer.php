...
use PGS\CoreDomainBundle\Model\Category\map\CategoryTableMap;
...
abstract class BaseCategoryPeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Category\\Category';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Category\\map\\CategoryTableMap';
    ...
    const AUTHOR_ID = 'category.author_id';
    ...
    const TREE_LEVEL = 'category.tree_level';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'AuthorId', 'Status', 'CreatedAt', 'UpdatedAt', 'TreeLeft', 'TreeRight', 'TreeLevel', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'authorId', 'status', 'createdAt', 'updatedAt', 'treeLeft', 'treeRight', 'treeLevel', ),
        BasePeer::TYPE_COLNAME => array (CategoryPeer::ID, CategoryPeer::AUTHOR_ID, CategoryPeer::STATUS, CategoryPeer::CREATED_AT, CategoryPeer::UPDATED_AT, CategoryPeer::TREE_LEFT, CategoryPeer::TREE_RIGHT, CategoryPeer::TREE_LEVEL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'AUTHOR_ID', 'STATUS', 'CREATED_AT', 'UPDATED_AT', 'TREE_LEFT', 'TREE_RIGHT', 'TREE_LEVEL', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'author_id', 'status', 'created_at', 'updated_at', 'tree_left', 'tree_right', 'tree_level', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AuthorId' => 1, 'Status' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'TreeLeft' => 5, 'TreeRight' => 6, 'TreeLevel' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'authorId' => 1, 'status' => 2, 'createdAt' => 3, 'updatedAt' => 4, 'treeLeft' => 5, 'treeRight' => 6, 'treeLevel' => 7, ),
        BasePeer::TYPE_COLNAME => array (CategoryPeer::ID => 0, CategoryPeer::AUTHOR_ID => 1, CategoryPeer::STATUS => 2, CategoryPeer::CREATED_AT => 3, CategoryPeer::UPDATED_AT => 4, CategoryPeer::TREE_LEFT => 5, CategoryPeer::TREE_RIGHT => 6, CategoryPeer::TREE_LEVEL => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'AUTHOR_ID' => 1, 'STATUS' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, 'TREE_LEFT' => 5, 'TREE_RIGHT' => 6, 'TREE_LEVEL' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'author_id' => 1, 'status' => 2, 'created_at' => 3, 'updated_at' => 4, 'tree_left' => 5, 'tree_right' => 6, 'tree_level' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryPeer::AUTHOR_ID);
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = CategoryPeer::getInstanceFromPool($key))) {
            ...
            $cls = CategoryPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CategoryPeer::AUTHOR_ID, UserPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Category objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Category) to $obj2 (User)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Category) to the collection in $obj2 (User)
                $obj2->addCategory($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCategoryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\Category\map\CategoryTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(CategoryPeer::OM_CLASS, $row, $colnum);
    ...
    public static function deleteTree(PropelPDO $con = null)
    {
        ...
        return CategoryPeer::doDeleteAll($con);
    }
    ...
    public static function makeRoomForLeaf($left, $prune = null, PropelPDO $con = null)
    {
        ...
        CategoryPeer::shiftRLValues(2, $left, null, $con);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\Category\om\BaseCategoryPeer'));
