...
abstract class BaseCategory extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\Category\\CategoryPeer';
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[] = CategoryPeer::AUTHOR_ID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CategoryPeer::AUTHOR_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryPeer::AUTHOR_ID)) $criteria->add(CategoryPeer::AUTHOR_ID, $this->author_id);
    ...
    public function addCategoryI18n(CategoryI18n $l)
    {
        ...
        if (!in_array($l, $this->collCategoryI18ns->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            ...
            if ($this->categoryI18nsScheduledForDeletion and $this->categoryI18nsScheduledForDeletion->contains($l)) {
                $this->categoryI18nsScheduledForDeletion->remove($this->categoryI18nsScheduledForDeletion->search($l));
            }
        }
    ...
    public function insertAsFirstChildOf($parent)
    {
        ...
        $this->nestedSetQueries []= array(
            'callable'  => array('\\PGS\CoreDomainBundle\Model\Category\\CategoryPeer', 'makeRoomForLeaf'),
