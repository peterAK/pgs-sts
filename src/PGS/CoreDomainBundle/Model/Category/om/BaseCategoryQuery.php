 ...
 * @method CategoryQuery orderByAuthorId($order = Criteria::ASC) Order by the author_id column
 * @method CategoryQuery orderByStatus($order = Criteria::ASC) Order by the status column
 ...
 * @method CategoryQuery groupByAuthorId() Group by the author_id column
 * @method CategoryQuery groupByStatus() Group by the status column
 ...
 *
 * @method Category findOneByAuthorId(int $author_id) Return the first Category filtered by the author_id column
 * @method Category findOneByStatus(string $status) Return the first Category filtered by the status column
 ...
 * @method array findByAuthorId(int $author_id) Return Category objects filtered by the author_id column
 * @method array findByStatus(string $status) Return Category objects filtered by the status column
...
abstract class BaseCategoryQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'PGS\\CoreDomainBundle\\Model\\Category\\Category';
        }
    ...
    {
        $sql = 'SELECT `id`, `author_id`, `status`, `created_at`, `updated_at`, `tree_left`, `tree_right`, `tree_level` FROM `category` WHERE `id` = :p0';
        try {
    ...
    public function filterByAuthorId($authorId = null, $comparison = null)
    {
        if (is_array($authorId)) {
            ...
            if (isset($authorId['min'])) {
                $this->addUsingAlias(CategoryPeer::AUTHOR_ID, $authorId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($authorId['max'])) {
                $this->addUsingAlias(CategoryPeer::AUTHOR_ID, $authorId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryPeer::AUTHOR_ID, $authorId, $comparison);
    }
    ...
    public function filterByStatus($status = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryPeer::STATUS, $status, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(CategoryPeer::AUTHOR_ID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CategoryPeer::AUTHOR_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \PGS\CoreDomainBundle\Model\Category\CategoryI18nQuery A secondary query class using the current class as primary query
     */
    public function useCategoryI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinCategoryI18n($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CategoryI18n', '\PGS\CoreDomainBundle\Model\Category\CategoryI18nQuery');
    }
