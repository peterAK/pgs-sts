...
abstract class BaseCategoryI18n extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\Category\\CategoryI18nPeer';
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CategoryI18nPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CategoryI18nPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(CategoryI18nPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(CategoryI18nPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(CategoryI18nPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CategoryI18nPeer::NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryI18nPeer::CREATED_AT)) $criteria->add(CategoryI18nPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(CategoryI18nPeer::UPDATED_AT)) $criteria->add(CategoryI18nPeer::UPDATED_AT, $this->updated_at);
