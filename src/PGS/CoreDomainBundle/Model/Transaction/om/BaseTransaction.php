...
abstract class BaseTransaction extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\Transaction\\TransactionPeer';
    ...
    /**
     * The value for the visitation_id field.
     * @var        int
     */
    protected $visitation_id;
    ...
    /**
     * Get the [visitation_id] column value.
     *
     * @return int
     */
    public function getVisitationId()
    {

        return $this->visitation_id;
    }
    ...
    /**
     * Set the value of [visitation_id] column.
     *
     * @param  int $v new value
     * @return Transaction The current object (for fluent API support)
     */
    public function setVisitationId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->visitation_id !== $v) {
            $this->visitation_id = $v;
            $this->modifiedColumns[] = TransactionPeer::VISITATION_ID;
        }

        if ($this->aVisitation !== null && $this->aVisitation->getId() !== $v) {
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[] = TransactionPeer::PRODUCT_ID;
        }
    ...
    public function setQuantity($v)
    {
        ...
        if ($this->quantity !== $v) {
            $this->quantity = $v;
            $this->modifiedColumns[] = TransactionPeer::QUANTITY;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[] = TransactionPeer::PRICE;
        }
    ...
    public function setSubtotal($v)
    {
        ...
        if ($this->subtotal !== $v) {
            $this->subtotal = $v;
            $this->modifiedColumns[] = TransactionPeer::SUBTOTAL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->visitation_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aVisitation !== null && $this->visitation_id !== $this->aVisitation->getId()) {
            $this->aVisitation = null;
        }
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                // aggregate_column_relation behavior
                $this->updateRelatedVisitation($con);
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aVisitation !== null) {
                if ($this->aVisitation->isModified() || $this->aVisitation->isNew()) {
                    $affectedRows += $this->aVisitation->save($con);
                }
                $this->setVisitation($this->aVisitation);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TransactionPeer::VISITATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`visitation_id`';
        }
        if ($this->isColumnModified(TransactionPeer::PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`product_id`';
        }
        if ($this->isColumnModified(TransactionPeer::QUANTITY)) {
            $modifiedColumns[':p' . $index++]  = '`quantity`';
        }
        if ($this->isColumnModified(TransactionPeer::PRICE)) {
            $modifiedColumns[':p' . $index++]  = '`price`';
        }
        if ($this->isColumnModified(TransactionPeer::SUBTOTAL)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`visitation_id`':
                        $stmt->bindValue($identifier, $this->visitation_id, PDO::PARAM_INT);
                        break;
                    case '`product_id`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aVisitation !== null) {
                if (!$this->aVisitation->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aVisitation->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aVisitation) {
                $result['Visitation'] = $this->aVisitation->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setVisitationId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TransactionPeer::VISITATION_ID)) $criteria->add(TransactionPeer::VISITATION_ID, $this->visitation_id);
        if ($this->isColumnModified(TransactionPeer::PRODUCT_ID)) $criteria->add(TransactionPeer::PRODUCT_ID, $this->product_id);
        if ($this->isColumnModified(TransactionPeer::QUANTITY)) $criteria->add(TransactionPeer::QUANTITY, $this->quantity);
        if ($this->isColumnModified(TransactionPeer::PRICE)) $criteria->add(TransactionPeer::PRICE, $this->price);
        if ($this->isColumnModified(TransactionPeer::SUBTOTAL)) $criteria->add(TransactionPeer::SUBTOTAL, $this->subtotal);
    ...
    {
        $copyObj->setVisitationId($this->getVisitationId());
    ...
    public function getProduct(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProduct === null && ($this->product_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProduct->addTransactions($this);
             */
        }
    ...
    /**
     * Update the aggregate column in the related Visitation object
     *
     * @param PropelPDO $con A connection object
     */
    protected function updateRelatedVisitation(PropelPDO $con)
    {
        if ($visitation = $this->getVisitation()) {
            if (!$visitation->isAlreadyInSave()) {
                $visitation->updateTotal($con);
            }
        }
        if ($this->oldVisitation) {
            $this->oldVisitation->updateTotal($con);
            $this->oldVisitation = null;
        }
    }
