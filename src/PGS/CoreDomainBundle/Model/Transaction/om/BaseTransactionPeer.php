...
use PGS\CoreDomainBundle\Model\Transaction\map\TransactionTableMap;
...
abstract class BaseTransactionPeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Transaction\\Transaction';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Transaction\\map\\TransactionTableMap';
    ...
    /** the column name for the visitation_id field */
    const VISITATION_ID = 'transaction.visitation_id';

    /** the column name for the product_id field */
    const PRODUCT_ID = 'transaction.product_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'VisitationId', 'ProductId', 'Quantity', 'Price', 'Subtotal', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'visitationId', 'productId', 'quantity', 'price', 'subtotal', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (TransactionPeer::ID, TransactionPeer::VISITATION_ID, TransactionPeer::PRODUCT_ID, TransactionPeer::QUANTITY, TransactionPeer::PRICE, TransactionPeer::SUBTOTAL, TransactionPeer::CREATED_AT, TransactionPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'VISITATION_ID', 'PRODUCT_ID', 'QUANTITY', 'PRICE', 'SUBTOTAL', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'visitation_id', 'product_id', 'quantity', 'price', 'subtotal', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'VisitationId' => 1, 'ProductId' => 2, 'Quantity' => 3, 'Price' => 4, 'Subtotal' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'visitationId' => 1, 'productId' => 2, 'quantity' => 3, 'price' => 4, 'subtotal' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        BasePeer::TYPE_COLNAME => array (TransactionPeer::ID => 0, TransactionPeer::VISITATION_ID => 1, TransactionPeer::PRODUCT_ID => 2, TransactionPeer::QUANTITY => 3, TransactionPeer::PRICE => 4, TransactionPeer::SUBTOTAL => 5, TransactionPeer::CREATED_AT => 6, TransactionPeer::UPDATED_AT => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'VISITATION_ID' => 1, 'PRODUCT_ID' => 2, 'QUANTITY' => 3, 'PRICE' => 4, 'SUBTOTAL' => 5, 'CREATED_AT' => 6, 'UPDATED_AT' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'visitation_id' => 1, 'product_id' => 2, 'quantity' => 3, 'price' => 4, 'subtotal' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TransactionPeer::VISITATION_ID);
            $criteria->addSelectColumn(TransactionPeer::PRODUCT_ID);
            $criteria->addSelectColumn(TransactionPeer::QUANTITY);
            $criteria->addSelectColumn(TransactionPeer::PRICE);
            $criteria->addSelectColumn(TransactionPeer::SUBTOTAL);
            $criteria->addSelectColumn(TransactionPeer::CREATED_AT);
            $criteria->addSelectColumn(TransactionPeer::UPDATED_AT);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.visitation_id');
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = TransactionPeer::getInstanceFromPool($key))) {
            ...
            $cls = TransactionPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    /**
     * Returns the number of rows matching criteria, joining the related Visitation table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinVisitation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TransactionPeer::VISITATION_ID, VisitationPeer::ID, $join_behavior);
    ...
    public static function doCountJoinProduct(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TransactionPeer::PRODUCT_ID, ProductPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Transaction objects pre-filled with their Visitation objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinVisitation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = VisitationPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = VisitationPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    VisitationPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Transaction) to $obj2 (Visitation)
    ...
    /**
     * Selects a collection of Transaction objects pre-filled with their Product objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Transaction objects.
    ...
    public static function doSelectJoinProduct(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Transaction) to $obj2 (Product)
                $obj2->addTransaction($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined Visitation rows

            $key2 = VisitationPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = VisitationPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (Transaction) to the collection in $obj2 (Visitation)
                $obj2->addTransaction($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Transaction) to the collection in $obj3 (Product)
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptVisitation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of Transaction objects pre-filled with all related objects except Visitation.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptVisitation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = TransactionPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Transaction) to the collection in $obj2 (Product)
                $obj2->addTransaction($obj1);
    ...
    /**
     * Selects a collection of Transaction objects pre-filled with all related objects except Product.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseTransactionPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\Transaction\map\TransactionTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(TransactionPeer::OM_CLASS, $row, $colnum);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\Transaction\om\BaseTransactionPeer'));
