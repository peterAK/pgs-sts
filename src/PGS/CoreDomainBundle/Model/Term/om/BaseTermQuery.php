 ...
 * @method TermQuery orderBySortableRank($order = Criteria::ASC) Order by the sortable_rank column
 ...
 * @method TermQuery groupBySortableRank() Group by the sortable_rank column
 ...
 *
 * @method TermQuery leftJoinSchoolTerm($relationAlias = null) Adds a LEFT JOIN clause to the query using the SchoolTerm relation
 * @method TermQuery rightJoinSchoolTerm($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SchoolTerm relation
 * @method TermQuery innerJoinSchoolTerm($relationAlias = null) Adds a INNER JOIN clause to the query using the SchoolTerm relation
 *
 * @method TermQuery leftJoinTermI18n($relationAlias = null) Adds a LEFT JOIN clause to the query using the TermI18n relation
 * @method TermQuery rightJoinTermI18n($relationAlias = null) Adds a RIGHT JOIN clause to the query using the TermI18n relation
 * @method TermQuery innerJoinTermI18n($relationAlias = null) Adds a INNER JOIN clause to the query using the TermI18n relation
 *
 ...
 *
 * @method Term findOneBySortableRank(int $sortable_rank) Return the first Term filtered by the sortable_rank column
 ...
 * @method array findBySortableRank(int $sortable_rank) Return Term objects filtered by the sortable_rank column
...
abstract class BaseTermQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'PGS\\CoreDomainBundle\\Model\\Term\\Term';
        }
     ...
     * @param   TermQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return TermQuery
     */
     ...
     *
     * @return   Term|Term[]|mixed the result, formatted by the current formatter
     */
    ...
    {
        $sql = 'SELECT `id`, `sortable_rank`, `created_at`, `updated_at` FROM `term` WHERE `id` = :p0';
        try {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|Term[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(TermPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(TermPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterBySortableRank($sortableRank = null, $comparison = null)
    {
        if (is_array($sortableRank)) {
            ...
            if (isset($sortableRank['min'])) {
                $this->addUsingAlias(TermPeer::SORTABLE_RANK, $sortableRank['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($sortableRank['max'])) {
                $this->addUsingAlias(TermPeer::SORTABLE_RANK, $sortableRank['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TermPeer::SORTABLE_RANK, $sortableRank, $comparison);
    }
    ...
    public function filterBySchoolTerm($schoolTerm, $comparison = null)
    {
        if ($schoolTerm instanceof SchoolTerm) {
            return $this
                ->addUsingAlias(TermPeer::ID, $schoolTerm->getTermId(), $comparison);
    ...
    /**
     * Filter the query by a related TermI18n object
     *
     * @param   TermI18n|PropelObjectCollection $termI18n  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 TermQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByTermI18n($termI18n, $comparison = null)
    {
        if ($termI18n instanceof TermI18n) {
            return $this
                ->addUsingAlias(TermPeer::ID, $termI18n->getId(), $comparison);
        } elseif ($termI18n instanceof PropelObjectCollection) {
            return $this
                ->useTermI18nQuery()
                ->filterByPrimaryKeys($termI18n->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByTermI18n() only accepts arguments of type TermI18n or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the TermI18n relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return TermQuery The current query, for fluid interface
     */
    public function joinTermI18n($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('TermI18n');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'TermI18n');
        }
    ...
    /**
     * Use the TermI18n relation TermI18n object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \PGS\CoreDomainBundle\Model\Term\TermI18nQuery A secondary query class using the current class as primary query
     */
    public function useTermI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinTermI18n($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'TermI18n', '\PGS\CoreDomainBundle\Model\Term\TermI18nQuery');
    }
    ...
    public function filterByRank($rank)
    {
        ...
        return $this
            ->addUsingAlias(TermPeer::RANK_COL, $rank, Criteria::EQUAL);
    }
    ...
    public function orderByRank($order = Criteria::ASC)
    {
        ...
        switch ($order) {
            case Criteria::ASC:
                return $this->addAscendingOrderByColumn($this->getAliasedColName(TermPeer::RANK_COL));
                break;
            case Criteria::DESC:
                return $this->addDescendingOrderByColumn($this->getAliasedColName(TermPeer::RANK_COL));
                break;
            default:
                throw new PropelException('TermQuery::orderBy() only accepts "asc" or "desc" as argument');
        }
    }
    ...
    public function getMaxRank(PropelPDO $con = null)
    {
        ...
        $this->addSelectColumn('MAX(' . TermPeer::RANK_COL . ')');
    ...
    {
        $relationName = $relationAlias ? $relationAlias : 'TermI18n';
    ...
    public function joinWithI18n($locale = 'en_US', $joinType = Criteria::LEFT_JOIN)
    {
        $this
            ...
            ->with('TermI18n');
        $this->with['TermI18n']->setIsWithOneToMany(false);
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'. Defaults to left join.
     *
     * @return    TermI18nQuery A secondary query class using the current class as primary query
     */
