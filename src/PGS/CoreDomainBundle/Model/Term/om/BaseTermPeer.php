...
use PGS\CoreDomainBundle\Model\Term\map\TermTableMap;
...
abstract class BaseTermPeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Term\\Term';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Term\\map\\TermTableMap';
    ...
    const SORTABLE_RANK = 'term.sortable_rank';
    ...
    /**
     * An identity map to hold any loaded instances of Term objects.
     ...
     * rank column
     */
    const RANK_COL = 'term.sortable_rank';

    /**
     * holds an array of fieldnames
     *
     * first dimension keys are the type constants
     * e.g. TermPeer::$fieldNames[TermPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (TermPeer::ID, TermPeer::SORTABLE_RANK, TermPeer::CREATED_AT, TermPeer::UPDATED_AT, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. TermPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (TermPeer::ID => 0, TermPeer::SORTABLE_RANK => 1, TermPeer::CREATED_AT => 2, TermPeer::UPDATED_AT => 3, ),
    ...
    {
        $toNames = TermPeer::getFieldNames($toType);
        $key = isset(TermPeer::$fieldKeys[$fromType][$name]) ? TermPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(TermPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, TermPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return TermPeer::$fieldNames[$type];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TermPeer::SORTABLE_RANK);
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(TermPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(TermPeer::DATABASE_NAME);
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(TermPeer::$instances[$key])) {
                return TermPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (TermPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        TermPeer::$instances = array();
    }
    ...
    {
        // Invalidate objects in TermI18nPeer instance pool,
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = TermPeer::getInstanceFromPool($key))) {
            ...
            $cls = TermPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    {
        return Propel::getDatabaseMap(TermPeer::DATABASE_NAME)->getTable(TermPeer::TABLE_NAME);
    }
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseTermPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\Term\map\TermTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(TermPeer::OM_CLASS, $row, $colnum);
    ...
    public static function getMaxRank(PropelPDO $con = null)
    {
        ...
        $c = new Criteria();
        $c->addSelectColumn('MAX(' . TermPeer::RANK_COL . ')');
        $stmt = TermPeer::doSelectStmt($c, $con);
    ...
    public static function retrieveByRank($rank, PropelPDO $con = null)
    {
        ...
        $c = new Criteria;
        $c->add(TermPeer::RANK_COL, $rank);

        return TermPeer::doSelectOne($c, $con);
    }
    ...
    public static function reorder(array $order, PropelPDO $con = null)
    {
        ...
        try {
            ...
            $objects = TermPeer::retrieveByPKs($ids);
    ...
    public static function doSelectOrderByRank(Criteria $criteria = null, $order = Criteria::ASC, PropelPDO $con = null)
    {
        ...
        if ($order == Criteria::ASC) {
            $criteria->addAscendingOrderByColumn(TermPeer::RANK_COL);
        } else {
            $criteria->addDescendingOrderByColumn(TermPeer::RANK_COL);
        }

        return TermPeer::doSelect($criteria, $con);
    }
    ...
    public static function shiftRank($delta, $first = null, $last = null, PropelPDO $con = null)
    {
        ...
        $whereCriteria = TermQuery::create();
        if (null !== $first) {
            $whereCriteria->add(TermPeer::RANK_COL, $first, Criteria::GREATER_EQUAL);
        }
        if (null !== $last) {
            $whereCriteria->addAnd(TermPeer::RANK_COL, $last, Criteria::LESS_EQUAL);
        }

        $valuesCriteria = new Criteria(TermPeer::DATABASE_NAME);
        $valuesCriteria->add(TermPeer::RANK_COL, array('raw' => TermPeer::RANK_COL . ' + ?', 'value' => $delta), Criteria::CUSTOM_EQUAL);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\Term\om\BaseTermPeer'));
