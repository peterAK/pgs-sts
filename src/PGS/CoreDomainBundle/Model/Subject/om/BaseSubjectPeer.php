...
use PGS\CoreDomainBundle\Model\Subject\map\SubjectTableMap;
...
abstract class BaseSubjectPeer
{
    ...
    const OM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Subject\\Subject';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PGS\\CoreDomainBundle\\Model\\Subject\\map\\SubjectTableMap';
    ...
    const SORTABLE_RANK = 'subject.sortable_rank';

    /** the column name for the created_at field */
    const CREATED_AT = 'subject.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'subject.updated_at';
     ...
     * rank column
     */
    const RANK_COL = 'subject.sortable_rank';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (SubjectPeer::ID, SubjectPeer::SORTABLE_RANK, SubjectPeer::CREATED_AT, SubjectPeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (SubjectPeer::ID => 0, SubjectPeer::SORTABLE_RANK => 1, SubjectPeer::CREATED_AT => 2, SubjectPeer::UPDATED_AT => 3, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SubjectPeer::SORTABLE_RANK);
    ...
    public static function clearRelatedInstancePool()
    {
        ...
        // Invalidate objects in SubjectI18nPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = SubjectPeer::getInstanceFromPool($key))) {
            ...
            $cls = SubjectPeer::getOMClass($row, $startcol);
            $obj = new $cls();
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseSubjectPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \PGS\CoreDomainBundle\Model\Subject\map\SubjectTableMap());
      }
    }
    ...
    public static function getOMClass($row = 0, $colnum = 0)
    {
        ...
        $event = new DetectOMClassEvent(SubjectPeer::OM_CLASS, $row, $colnum);
    ...
    public static function getMaxRank(PropelPDO $con = null)
    {
        ...
        $c = new Criteria();
        $c->addSelectColumn('MAX(' . SubjectPeer::RANK_COL . ')');
        $stmt = SubjectPeer::doSelectStmt($c, $con);
    ...
    public static function retrieveByRank($rank, PropelPDO $con = null)
    {
        ...
        $c = new Criteria;
        $c->add(SubjectPeer::RANK_COL, $rank);

        return SubjectPeer::doSelectOne($c, $con);
    }
    ...
    public static function reorder(array $order, PropelPDO $con = null)
    {
        ...
        try {
            ...
            $objects = SubjectPeer::retrieveByPKs($ids);
    ...
    public static function doSelectOrderByRank(Criteria $criteria = null, $order = Criteria::ASC, PropelPDO $con = null)
    {
        ...
        if ($order == Criteria::ASC) {
            $criteria->addAscendingOrderByColumn(SubjectPeer::RANK_COL);
        } else {
            $criteria->addDescendingOrderByColumn(SubjectPeer::RANK_COL);
        }

        return SubjectPeer::doSelect($criteria, $con);
    }
    ...
    public static function shiftRank($delta, $first = null, $last = null, PropelPDO $con = null)
    {
        ...
        $whereCriteria = SubjectQuery::create();
        if (null !== $first) {
            $whereCriteria->add(SubjectPeer::RANK_COL, $first, Criteria::GREATER_EQUAL);
        }
        if (null !== $last) {
            $whereCriteria->addAnd(SubjectPeer::RANK_COL, $last, Criteria::LESS_EQUAL);
        }

        $valuesCriteria = new Criteria(SubjectPeer::DATABASE_NAME);
        $valuesCriteria->add(SubjectPeer::RANK_COL, array('raw' => SubjectPeer::RANK_COL . ' + ?', 'value' => $delta), Criteria::CUSTOM_EQUAL);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('PGS\CoreDomainBundle\Model\Subject\om\BaseSubjectPeer'));
