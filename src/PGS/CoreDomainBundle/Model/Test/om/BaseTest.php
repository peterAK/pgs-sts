...
abstract class BaseTest extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\Test\\TestPeer';
    ...
    /**
     * @var        PropelObjectCollection|TestI18n[] Collection to store aggregation of TestI18n objects.
     */
    protected $collTestI18ns;
    protected $collTestI18nsPartial;
     ...
     * @var		PropelObjectCollection
     */
    protected $testI18nsScheduledForDeletion = null;
    ...
    public function getStatus()
    {
        ...
        $valueSet = TestPeer::getValueSet(TestPeer::STATUS);
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = TestPeer::STATUS;
        }
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[] = TestPeer::AUTHOR_ID;
        }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TestPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = TestPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(TestPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(TestPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(TestPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->testI18nsScheduledForDeletion !== null) {
                if (!$this->testI18nsScheduledForDeletion->isEmpty()) {
                    TestI18nQuery::create()
                        ->filterByPrimaryKeys($this->testI18nsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->testI18nsScheduledForDeletion = null;
                }
            }

            if ($this->collTestI18ns !== null) {
                foreach ($this->collTestI18ns as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TestPeer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`status`';
        }
        if ($this->isColumnModified(TestPeer::AUTHOR_ID)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collTestI18ns) {
                $result['TestI18ns'] = $this->collTestI18ns->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TestPeer::STATUS)) $criteria->add(TestPeer::STATUS, $this->status);
        if ($this->isColumnModified(TestPeer::AUTHOR_ID)) $criteria->add(TestPeer::AUTHOR_ID, $this->author_id);
        if ($this->isColumnModified(TestPeer::CREATED_AT)) $criteria->add(TestPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(TestPeer::UPDATED_AT)) $criteria->add(TestPeer::UPDATED_AT, $this->updated_at);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getTestI18ns() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addTestI18n($relObj->copy($deepCopy));
                }
            }
    ...
    public function setSchoolTests(PropelCollection $schoolTests, PropelPDO $con = null)
    {
        ...
        foreach ($schoolTestsToDelete as $schoolTestRemoved) {
            $schoolTestRemoved->setTest(null);
        }
     ...
     * @return PropelObjectCollection|SchoolTest[] List of SchoolTest objects
     */
    public function getSchoolTestsJoinSchool($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SchoolTestQuery::create(null, $criteria);
    ...
    /**
     * Clears out the collTestI18ns collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     ...
     * @see        addTestI18ns()
     */
    public function clearTestI18ns()
    {
        $this->collTestI18ns = null; // important to set this to null since that means it is uninitialized
        $this->collTestI18nsPartial = null;

        return $this;
    }

    /**
     * reset is the collTestI18ns collection loaded partially
     *
     * @return void
     */
    public function resetPartialTestI18ns($v = true)
    {
        $this->collTestI18nsPartial = $v;
    }

    /**
     * Initializes the collTestI18ns collection.
     *
     * By default this just sets the collTestI18ns collection to an empty array (like clearcollTestI18ns());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initTestI18ns($overrideExisting = true)
    {
        if (null !== $this->collTestI18ns && !$overrideExisting) {
            return;
        }
        $this->collTestI18ns = new PropelObjectCollection();
        $this->collTestI18ns->setModel('TestI18n');
    }

    /**
     * Gets an array of TestI18n objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|TestI18n[] List of TestI18n objects
     * @throws PropelException
     */
    public function getTestI18ns($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collTestI18nsPartial && !$this->isNew();
        if (null === $this->collTestI18ns || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collTestI18ns) {
                // return empty collection
                $this->initTestI18ns();
            } else {
                $collTestI18ns = TestI18nQuery::create(null, $criteria)
                    ->filterByTest($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collTestI18nsPartial && count($collTestI18ns)) {
                      $this->initTestI18ns(false);

                      foreach ($collTestI18ns as $obj) {
                        if (false == $this->collTestI18ns->contains($obj)) {
                          $this->collTestI18ns->append($obj);
                        }
                      }

                      $this->collTestI18nsPartial = true;
                    }

                    $collTestI18ns->getInternalIterator()->rewind();

                    return $collTestI18ns;
                }

                if ($partial && $this->collTestI18ns) {
                    foreach ($this->collTestI18ns as $obj) {
                        if ($obj->isNew()) {
                            $collTestI18ns[] = $obj;
                        }
                    }
                ...
                $this->collTestI18ns = $collTestI18ns;
                $this->collTestI18nsPartial = false;
            }
        }

        return $this->collTestI18ns;
    }

    /**
     * Sets a collection of TestI18n objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $testI18ns A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Test The current object (for fluent API support)
     */
    public function setTestI18ns(PropelCollection $testI18ns, PropelPDO $con = null)
    {
        $testI18nsToDelete = $this->getTestI18ns(new Criteria(), $con)->diff($testI18ns);


        //since at least one column in the foreign key is at the same time a PK
        //we can not just set a PK to NULL in the lines below. We have to store
        //a backup of all values, so we are able to manipulate these items based on the onDelete value later.
        $this->testI18nsScheduledForDeletion = clone $testI18nsToDelete;

        foreach ($testI18nsToDelete as $testI18nRemoved) {
            $testI18nRemoved->setTest(null);
        }

        $this->collTestI18ns = null;
        foreach ($testI18ns as $testI18n) {
            $this->addTestI18n($testI18n);
        }

        $this->collTestI18ns = $testI18ns;
        $this->collTestI18nsPartial = false;
    ...
    /**
     * Returns the number of related TestI18n objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related TestI18n objects.
     * @throws PropelException
     */
    public function countTestI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collTestI18nsPartial && !$this->isNew();
        if (null === $this->collTestI18ns || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collTestI18ns) {
            ...
            if ($partial && !$criteria) {
                return count($this->getTestI18ns());
            }
            $query = TestI18nQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collTestI18ns);
    }

    /**
     * Method called to associate a TestI18n object to this object
     * through the TestI18n foreign key attribute.
     *
     * @param    TestI18n $l TestI18n
     * @return Test The current object (for fluent API support)
     */
    public function addTestI18n(TestI18n $l)
    {
        ...
        if (!in_array($l, $this->collTestI18ns->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddTestI18n($l);

            if ($this->testI18nsScheduledForDeletion and $this->testI18nsScheduledForDeletion->contains($l)) {
                $this->testI18nsScheduledForDeletion->remove($this->testI18nsScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param	TestI18n $testI18n The testI18n object to add.
     */
    protected function doAddTestI18n($testI18n)
    {
        $this->collTestI18ns[]= $testI18n;
        $testI18n->setTest($this);
    }

    /**
     * @param	TestI18n $testI18n The testI18n object to remove.
     * @return Test The current object (for fluent API support)
     */
    public function removeTestI18n($testI18n)
    {
        if ($this->getTestI18ns()->contains($testI18n)) {
            $this->collTestI18ns->remove($this->collTestI18ns->search($testI18n));
            if (null === $this->testI18nsScheduledForDeletion) {
                $this->testI18nsScheduledForDeletion = clone $this->collTestI18ns;
                $this->testI18nsScheduledForDeletion->clear();
            }
            $this->testI18nsScheduledForDeletion[]= clone $testI18n;
            $testI18n->setTest(null);
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collTestI18ns) {
                foreach ($this->collTestI18ns as $o) {
                    $o->clearAllReferences($deep);
                }
            }
        ...
        $this->collSchoolTests = null;
        if ($this->collTestI18ns instanceof PropelCollection) {
            $this->collTestI18ns->clearIterator();
        }
        $this->collTestI18ns = null;
        $this->aUser = null;
    }
    ...
    public function getTranslation($locale = 'en_US', PropelPDO $con = null)
    {
        if (!isset($this->currentTranslations[$locale])) {
            if (null !== $this->collTestI18ns) {
                foreach ($this->collTestI18ns as $translation) {
            ...
            if ($this->isNew()) {
                $translation = new TestI18n();
                $translation->setLocale($locale);
            } else {
                $translation = TestI18nQuery::create()
                    ->filterByPrimaryKey(array($this->getPrimaryKey(), $locale))
                    ->findOneOrCreate($con);
                $this->currentTranslations[$locale] = $translation;
            }
            $this->addTestI18n($translation);
        }
    ...
    public function removeTranslation($locale = 'en_US', PropelPDO $con = null)
    {
        ...
        foreach ($this->collTestI18ns as $key => $translation) {
            if ($translation->getLocale() == $locale) {
                unset($this->collTestI18ns[$key]);
                break;
            }
        }
    ...
    public function getCurrentTranslation(PropelPDO $con = null)
    {
         ...
         * @return TestI18n The current object (for fluent API support)
         */
