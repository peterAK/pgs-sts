...
abstract class BasePrincipalI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\Principal\\PrincipalI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PrincipalI18nPeer
     */
    ...
    /**
     * Initializes internal state of BasePrincipalI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PrincipalI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = PrincipalI18nPeer::LOCALE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PrincipalI18nPeer::DESCRIPTION;
        }
    ...
    public function setExcerpt($v)
    {
        ...
        if ($this->excerpt !== $v) {
            $this->excerpt = $v;
            $this->modifiedColumns[] = PrincipalI18nPeer::EXCERPT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = PrincipalI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PrincipalI18n object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPrincipal !== null && $this->id !== $this->aPrincipal->getId()) {
            $this->aPrincipal = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PrincipalI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = PrincipalI18nQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                PrincipalI18nPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PrincipalI18nPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PrincipalI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(PrincipalI18nPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PrincipalI18nPeer::EXCERPT)) {
            $modifiedColumns[':p' . $index++]  = '`excerpt`';
        }

        $sql = sprintf(
            'INSERT INTO `principal_i18n` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PrincipalI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PrincipalI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PrincipalI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PrincipalI18n'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PrincipalI18nPeer::ID)) $criteria->add(PrincipalI18nPeer::ID, $this->id);
        if ($this->isColumnModified(PrincipalI18nPeer::LOCALE)) $criteria->add(PrincipalI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(PrincipalI18nPeer::DESCRIPTION)) $criteria->add(PrincipalI18nPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PrincipalI18nPeer::EXCERPT)) $criteria->add(PrincipalI18nPeer::EXCERPT, $this->excerpt);
    ...
    {
        $criteria = new Criteria(PrincipalI18nPeer::DATABASE_NAME);
        $criteria->add(PrincipalI18nPeer::ID, $this->id);
        $criteria->add(PrincipalI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of PrincipalI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PrincipalI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PrincipalI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PrincipalI18nPeer();
        }
    ...
    {
        if ($this->aPrincipal === null && ($this->id !== null) && $doQuery) {
            $this->aPrincipal = PrincipalQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPrincipal->addPrincipalI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PrincipalI18nPeer::DEFAULT_STRING_FORMAT);
    }
