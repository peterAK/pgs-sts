...
abstract class BasePrincipalArchive extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\Principal\\PrincipalArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PrincipalArchivePeer
     */
    ...
    /**
     * Initializes internal state of BasePrincipalArchive object.
     * @see        applyDefaults()
     */
    ...
    public function getStatus()
    {
        ...
        $valueSet = PrincipalArchivePeer::getValueSet(PrincipalArchivePeer::STATUS);
    ...
    public function getConfirmation()
    {
        ...
        $valueSet = PrincipalArchivePeer::getValueSet(PrincipalArchivePeer::CONFIRMATION);
     ...
     * @return PrincipalArchive The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::USER_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::NAME;
        }
    ...
    public function setNameSlug($v)
    {
        ...
        if ($this->name_slug !== $v) {
            $this->name_slug = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::NAME_SLUG;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::DESCRIPTION;
        }
    ...
    public function setExcerpt($v)
    {
        ...
        if ($this->excerpt !== $v) {
            $this->excerpt = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::EXCERPT;
        }
    ...
    public function setGovermentLicense($v)
    {
        ...
        if ($this->goverment_license !== $v) {
            ...
            $this->modifiedColumns[] = PrincipalArchivePeer::GOVERMENT_LICENSE;
        }
    ...
    public function setJoinAt($v)
    {
        ...
        if ($this->join_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PrincipalArchivePeer::JOIN_AT;
            }
    ...
    public function setAddress1($v)
    {
        ...
        if ($this->address1 !== $v) {
            $this->address1 = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::ADDRESS1;
        }
    ...
    public function setAddress2($v)
    {
        ...
        if ($this->address2 !== $v) {
            $this->address2 = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::ADDRESS2;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::CITY;
        }
    ...
    public function setZipcode($v)
    {
        ...
        if ($this->zipcode !== $v) {
            $this->zipcode = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::ZIPCODE;
        }
    ...
    public function setCountryId($v)
    {
        ...
        if ($this->country_id !== $v) {
            $this->country_id = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::COUNTRY_ID;
        }
    ...
    public function setStateId($v)
    {
        ...
        if ($this->state_id !== $v) {
            $this->state_id = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::STATE_ID;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::PHONE;
        }
    ...
    public function setFax($v)
    {
        ...
        if ($this->fax !== $v) {
            $this->fax = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::FAX;
        }
    ...
    public function setMobile($v)
    {
        ...
        if ($this->mobile !== $v) {
            $this->mobile = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::MOBILE;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::EMAIL;
        }
    ...
    public function setWebsite($v)
    {
        ...
        if ($this->website !== $v) {
            $this->website = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::WEBSITE;
        }
    ...
    public function setLogo($v)
    {
        ...
        if ($this->logo !== $v) {
            $this->logo = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::LOGO;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::STATUS;
        }
    ...
    public function setIsPrincipal($v)
    {
        ...
        if ($this->is_principal !== $v) {
            $this->is_principal = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::IS_PRINCIPAL;
        }
    ...
    public function setConfirmation($v)
    {
        ...
        if ($this->confirmation !== $v) {
            $this->confirmation = $v;
            $this->modifiedColumns[] = PrincipalArchivePeer::CONFIRMATION;
        }
    ...
    public function setSortableRank($v)
    {
        ...
        if ($this->sortable_rank !== $v) {
            ...
            $this->modifiedColumns[] = PrincipalArchivePeer::SORTABLE_RANK;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PrincipalArchivePeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PrincipalArchivePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PrincipalArchivePeer::ARCHIVED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->is_principal = ($row[$startcol + 21] !== null) ? (boolean) $row[$startcol + 21] : null;
            $this->confirmation = ($row[$startcol + 22] !== null) ? (int) $row[$startcol + 22] : null;
            ...
            return $startcol + 27; // 27 = PrincipalArchivePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PrincipalArchive object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PrincipalArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = PrincipalArchiveQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                PrincipalArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PrincipalArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::NAME_SLUG)) {
            $modifiedColumns[':p' . $index++]  = '`name_slug`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::EXCERPT)) {
            $modifiedColumns[':p' . $index++]  = '`excerpt`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::GOVERMENT_LICENSE)) {
            $modifiedColumns[':p' . $index++]  = '`goverment_license`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::JOIN_AT)) {
            $modifiedColumns[':p' . $index++]  = '`join_at`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::ADDRESS1)) {
            $modifiedColumns[':p' . $index++]  = '`address1`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::ADDRESS2)) {
            $modifiedColumns[':p' . $index++]  = '`address2`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::CITY)) {
            $modifiedColumns[':p' . $index++]  = '`city`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::ZIPCODE)) {
            $modifiedColumns[':p' . $index++]  = '`zipcode`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::COUNTRY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`country_id`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::STATE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`state_id`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`phone`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::FAX)) {
            $modifiedColumns[':p' . $index++]  = '`fax`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::MOBILE)) {
            $modifiedColumns[':p' . $index++]  = '`mobile`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`email`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::WEBSITE)) {
            $modifiedColumns[':p' . $index++]  = '`website`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::LOGO)) {
            $modifiedColumns[':p' . $index++]  = '`logo`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`status`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::IS_PRINCIPAL)) {
            $modifiedColumns[':p' . $index++]  = '`is_principal`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::CONFIRMATION)) {
            $modifiedColumns[':p' . $index++]  = '`confirmation`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::SORTABLE_RANK)) {
            $modifiedColumns[':p' . $index++]  = '`sortable_rank`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }
        if ($this->isColumnModified(PrincipalArchivePeer::ARCHIVED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`archived_at`';
        }

        $sql = sprintf(
            'INSERT INTO `principal_archive` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PrincipalArchivePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PrincipalArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PrincipalArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PrincipalArchive'][$this->getPrimaryKey()] = true;
        $keys = PrincipalArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[21] => $this->getIsPrincipal(),
            $keys[22] => $this->getConfirmation(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[21], $arr)) $this->setIsPrincipal($arr[$keys[21]]);
        if (array_key_exists($keys[22], $arr)) $this->setConfirmation($arr[$keys[22]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PrincipalArchivePeer::ID)) $criteria->add(PrincipalArchivePeer::ID, $this->id);
        if ($this->isColumnModified(PrincipalArchivePeer::USER_ID)) $criteria->add(PrincipalArchivePeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(PrincipalArchivePeer::NAME)) $criteria->add(PrincipalArchivePeer::NAME, $this->name);
        if ($this->isColumnModified(PrincipalArchivePeer::NAME_SLUG)) $criteria->add(PrincipalArchivePeer::NAME_SLUG, $this->name_slug);
        if ($this->isColumnModified(PrincipalArchivePeer::DESCRIPTION)) $criteria->add(PrincipalArchivePeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(PrincipalArchivePeer::EXCERPT)) $criteria->add(PrincipalArchivePeer::EXCERPT, $this->excerpt);
        if ($this->isColumnModified(PrincipalArchivePeer::GOVERMENT_LICENSE)) $criteria->add(PrincipalArchivePeer::GOVERMENT_LICENSE, $this->goverment_license);
        if ($this->isColumnModified(PrincipalArchivePeer::JOIN_AT)) $criteria->add(PrincipalArchivePeer::JOIN_AT, $this->join_at);
        if ($this->isColumnModified(PrincipalArchivePeer::ADDRESS1)) $criteria->add(PrincipalArchivePeer::ADDRESS1, $this->address1);
        if ($this->isColumnModified(PrincipalArchivePeer::ADDRESS2)) $criteria->add(PrincipalArchivePeer::ADDRESS2, $this->address2);
        if ($this->isColumnModified(PrincipalArchivePeer::CITY)) $criteria->add(PrincipalArchivePeer::CITY, $this->city);
        if ($this->isColumnModified(PrincipalArchivePeer::ZIPCODE)) $criteria->add(PrincipalArchivePeer::ZIPCODE, $this->zipcode);
        if ($this->isColumnModified(PrincipalArchivePeer::COUNTRY_ID)) $criteria->add(PrincipalArchivePeer::COUNTRY_ID, $this->country_id);
        if ($this->isColumnModified(PrincipalArchivePeer::STATE_ID)) $criteria->add(PrincipalArchivePeer::STATE_ID, $this->state_id);
        if ($this->isColumnModified(PrincipalArchivePeer::PHONE)) $criteria->add(PrincipalArchivePeer::PHONE, $this->phone);
        if ($this->isColumnModified(PrincipalArchivePeer::FAX)) $criteria->add(PrincipalArchivePeer::FAX, $this->fax);
        if ($this->isColumnModified(PrincipalArchivePeer::MOBILE)) $criteria->add(PrincipalArchivePeer::MOBILE, $this->mobile);
        if ($this->isColumnModified(PrincipalArchivePeer::EMAIL)) $criteria->add(PrincipalArchivePeer::EMAIL, $this->email);
        if ($this->isColumnModified(PrincipalArchivePeer::WEBSITE)) $criteria->add(PrincipalArchivePeer::WEBSITE, $this->website);
        if ($this->isColumnModified(PrincipalArchivePeer::LOGO)) $criteria->add(PrincipalArchivePeer::LOGO, $this->logo);
        if ($this->isColumnModified(PrincipalArchivePeer::STATUS)) $criteria->add(PrincipalArchivePeer::STATUS, $this->status);
        if ($this->isColumnModified(PrincipalArchivePeer::IS_PRINCIPAL)) $criteria->add(PrincipalArchivePeer::IS_PRINCIPAL, $this->is_principal);
        if ($this->isColumnModified(PrincipalArchivePeer::CONFIRMATION)) $criteria->add(PrincipalArchivePeer::CONFIRMATION, $this->confirmation);
        if ($this->isColumnModified(PrincipalArchivePeer::SORTABLE_RANK)) $criteria->add(PrincipalArchivePeer::SORTABLE_RANK, $this->sortable_rank);
        if ($this->isColumnModified(PrincipalArchivePeer::CREATED_AT)) $criteria->add(PrincipalArchivePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PrincipalArchivePeer::UPDATED_AT)) $criteria->add(PrincipalArchivePeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(PrincipalArchivePeer::ARCHIVED_AT)) $criteria->add(PrincipalArchivePeer::ARCHIVED_AT, $this->archived_at);
    ...
    {
        $criteria = new Criteria(PrincipalArchivePeer::DATABASE_NAME);
        $criteria->add(PrincipalArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PrincipalArchive (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PrincipalArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PrincipalArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PrincipalArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(PrincipalArchivePeer::DEFAULT_STRING_FORMAT);
    }
