...
class AreaTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.PGS.CoreDomainBundle.Model.map.AreaTableMap';
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('AreaAssignment', 'PGS\\CoreDomainBundle\\Model\\AreaAssignment\\AreaAssignment', RelationMap::ONE_TO_MANY, array('id' => 'area_id', ), 'SET NULL', 'CASCADE', 'AreaAssignments');
        $this->addRelation('Store', 'PGS\\CoreDomainBundle\\Model\\Store\\Store', RelationMap::ONE_TO_MANY, array('id' => 'area_id', ), 'SET NULL', 'CASCADE', 'Stores');
    } // buildRelations()
