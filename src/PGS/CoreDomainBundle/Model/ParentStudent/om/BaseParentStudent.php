...
abstract class BaseParentStudent extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PGS\\CoreDomainBundle\\Model\\ParentStudent\\ParentStudentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ParentStudentPeer
     */
     ...
     * @return ParentStudent The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ParentStudentPeer::ID;
        }
    ...
    public function setApplicationId($v)
    {
        ...
        if ($this->application_id !== $v) {
            ...
            $this->modifiedColumns[] = ParentStudentPeer::APPLICATION_ID;
        }
    ...
    public function setStudentId($v)
    {
        ...
        if ($this->student_id !== $v) {
            $this->student_id = $v;
            $this->modifiedColumns[] = ParentStudentPeer::STUDENT_ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = ParentStudentPeer::USER_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ParentStudentPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ParentStudentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = ParentStudentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ParentStudent object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ParentStudentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = ParentStudentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ParentStudentPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ParentStudentPeer::UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ParentStudentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // event behavior
            ...
            if ($ret) {
                ...
                ParentStudentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ParentStudentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ParentStudentPeer::APPLICATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`application_id`';
        }
        if ($this->isColumnModified(ParentStudentPeer::STUDENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`student_id`';
        }
        if ($this->isColumnModified(ParentStudentPeer::USER_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `parent_student` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ParentStudentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ParentStudentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ParentStudent'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ParentStudent'][$this->getPrimaryKey()] = true;
        $keys = ParentStudentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ParentStudentPeer::ID)) $criteria->add(ParentStudentPeer::ID, $this->id);
        if ($this->isColumnModified(ParentStudentPeer::APPLICATION_ID)) $criteria->add(ParentStudentPeer::APPLICATION_ID, $this->application_id);
        if ($this->isColumnModified(ParentStudentPeer::STUDENT_ID)) $criteria->add(ParentStudentPeer::STUDENT_ID, $this->student_id);
        if ($this->isColumnModified(ParentStudentPeer::USER_ID)) $criteria->add(ParentStudentPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(ParentStudentPeer::CREATED_AT)) $criteria->add(ParentStudentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ParentStudentPeer::UPDATED_AT)) $criteria->add(ParentStudentPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ParentStudentPeer::DATABASE_NAME);
        $criteria->add(ParentStudentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ParentStudent (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ParentStudent Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ParentStudentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ParentStudentPeer();
        }
    ...
    public function getUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUser === null && ($this->user_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addParentStudents($this);
             */
        }
    ...
    public function getApplication(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aApplication === null && ($this->application_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aApplication->addParentStudents($this);
             */
        }
    ...
    public function getStudent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aStudent === null && ($this->student_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aStudent->addParentStudents($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ParentStudentPeer::DEFAULT_STRING_FORMAT);
    }
